  ...
  (t.rcrop = {
    ...
    (ResponsiveCrop = function (e, i) {
      ...
      (this.el = e instanceof t ? e : t(e)),
        ...
        (this.wrapper = t("<div>", { class: r + "wrapper" })),
        (this.cropArea = t("<div>", { class: r + "croparea" })),
        (this.cropData = { width: 0, height: 0, x: 0, y: 0 }),
        (this.outer = {
          wrapper: t("<div>", { class: r + "outer-wrapper" }),
          left: t("<div>", { class: r + "outer " + r + "outer-left" }),
          right: t("<div>", { class: r + "outer " + r + "outer-right" }),
          top: t("<div>", { class: r + "outer " + r + "outer-top" }),
          bottom: t("<div>", { class: r + "outer " + r + "outer-bottom" }),
        }),
      ...
      var o = function () {
          if (
            ...
            a.cropArea.append('<div class="' + r + 'croparea-inner">'),
            a.settings.grid)
          ) {
          ...
          if ((h(), a.settings.inputs)) {
            var i =
              0 != a.settings.inputsPrefix ? a.settings.inputsPrefix + "-" : "";
        ...
        s = function (e, i, r, n) {
          if (
            (!1 !== e &&
              ((a.cropData.width =
                "number" == typeof e ? e : z(a.clayfy.newSize.width)),
              (a.cropData.width = Math.max(
                a.cropData.width,
                a.settings.minSize[0]
              )),
              a.settings.maxSize[0] &&
                (a.cropData.width = Math.min(
                  a.cropData.width,
                  a.settings.maxSize[0]
                ))),
            !1 !== i &&
              ((a.cropData.height =
                "number" == typeof i ? i : z(a.clayfy.newSize.height)),
              (a.cropData.height = Math.max(
                a.cropData.height,
                a.settings.minSize[1]
              )),
              a.settings.maxSize[1] &&
                (a.cropData.height = Math.min(
                  a.cropData.height,
                  a.settings.maxSize[1]
                ))),
            (!1 !== i || !1 !== e) && a.settings.preserveAspectRatio)
          ) {
            var o = a.settings.maxSize[0] || a.image.width,
              h = a.settings.minSize[0];
            a.cropData.height * a.cropAspectRatio > o ||
            a.cropData.height * a.cropAspectRatio < h
              ? (a.cropData.height = Math.round(
                  a.cropData.width / a.cropAspectRatio
                ))
              : (a.cropData.width = Math.round(
                  a.cropData.height * a.cropAspectRatio
                ));
          }
          !1 !== r &&
            ((a.cropData.x =
              "number" == typeof r ? r : z(a.clayfy.newSize.left)),
            a.cropData.x + a.cropData.width > a.image.width &&
              (a.cropData.x = a.image.width - a.cropData.width)),
            !1 !== n &&
              ((a.cropData.y =
                "number" == typeof n ? n : z(a.clayfy.newSize.top)),
              a.cropData.y + a.cropData.height > a.image.height &&
                (a.cropData.y = a.image.height - a.cropData.height)),
            a.settings.inputs &&
        ...
        g = function () {
          ...
          a.cropArea.css({
            ...
            a.outer.top.height((h / i) * 100 + "%"),
            a.outer.bottom.css({ top: ((h + o) / i) * 100 + "%" }),
            a.outer.right.css({ left: ((p + n) / e) * 100 + "%" });
        },
        d = function () {
          var t = a.clayfy.newSize;
          a.outer.left.width(t.left),
            a.outer.top.height(t.top),
            a.outer.bottom.css({ top: t.top + t.outerHeight }),
            a.outer.right.css({ left: t.left + t.outerWidth });
        },
        l = function () {
          var t = a.settings,
            e = a.clayfy.settings;
        ...
        f = function () {
          ...
          var e = t.full
              ? a.image.height
              : Math.max(0.8 * a.image.height, t.minSize[1]),
            i = t.full
              ? a.image.width
              : Math.max(0.8 * a.image.width, t.minSize[0]);
          a.resize(i, e, "center", "center"),
            a.cropArea.on("mousedown touchstart", l),
            a.cropArea.on("clayfy-resizestart clayfy-dragstart", p),
            a.cropArea.on("clayfy-resizeend clayfy-drop", c),
            a.cropArea.on("clayfy-resize clayfy-drag", d),
            a.settings.preview.display &&
              (a.cropArea.on("clayfy-resize clayfy-drag", w),
              a.cropArea.on("clayfy-cancel", w)),
            a.cropArea.on("clayfy-resizeend clayfy-drop", g),
            a.cropArea.on("clayfy-cancel", g),
        ...
        u = function () {
          var t = a.settings.preview.size,
            ...
            i = a.clayfy
              ? a.clayfy.newSize
              : { width: a.cropArea.width(), height: a.cropArea.height() };
          return (
        ...
        y = function () {
          ...
          e && (e = e instanceof t ? e : t(e)),
            (e && e.length) ||
              ((e = t("<div>", { class: r + "preview-wrapper" })),
              a.wrapper.after(e));
          var i = u();
          (a.preview = t(
            '<canvas width="' + i[0] + '" height="' + i[1] + '"></canvas>'
          )),
            a.preview.appendTo(e);
        },
        w = function (t) {
          var e = a.cropData;
          t &&
          ...
          var i = u();
          a.preview.attr({ width: i[0], height: i[1] }),
            a.preview[0]
              .getContext("2d")
              .drawImage(
                a.image.instance,
        ...
        m = function (t, e) {
          if ("object" == typeof t) {
            ...
            for (var a in t)
              i[a] = "number" != typeof t[a] ? null : Math.round(t[a] * e);
            return i;
          }
      ...
      (this.getValues = function () {
        ...
        (this.resize = function (t, e, i, r) {
          var n,
            ...
            c = a.settings;
          (t = c.maxSize[0]
            ? Math.min(t, a.image.width, c.maxSize[0])
            : Math.min(t, a.image.width)),
            (e = c.maxSize[1]
              ? Math.min(e, a.image.height, c.maxSize[1])
              : Math.min(e, a.image.height)),
            (t = c.minSize[0] ? Math.max(t, c.minSize[0]) : t),
            (e = c.minSize[1] ? Math.max(e, c.minSize[1]) : e),
            c.preserveAspectRatio &&
              (t / e > a.cropAspectRatio
                ? (t = e * a.cropAspectRatio)
                : (e = t / a.cropAspectRatio)),
            (t = Math.round(t)),
            (e = Math.round(e)),
            (n = v(t)),
            (o = v(e)),
            (r =
              void 0 === r
                ? a.cropArea.position().top
                : "center" === r
                ? Math.round((a.image.height - e) / 2)
                : Math.round(r)) +
              e >
              a.image.height && (r = a.image.height - e),
            (p = v(r)),
            (i =
              void 0 === i
                ? a.cropData.x
                  ? z(a.cropArea.position().left)
                  : a.cropData.x
                : "center" === i
                ? Math.round((a.image.width - t) / 2)
                : Math.round(i)) +
              t >
              a.image.width && (i = a.image.width - t),
            (h = v(i)),
            a.cropArea.css({ width: n, height: o, top: p, left: h }),
  ...
  (t.fn[e] = function (a) {
    ...
    if ("string" == typeof a && "_" !== a[0] && "init" !== a) {
      ...
      return this.each(function () {
        ...
        n instanceof i &&
          "function" == typeof n[a] &&
          n[a].apply(n, Array.prototype.slice.call(r, 1)),
          "destroy" === a && t(this).removeData(e);
      });
    }
  }),
