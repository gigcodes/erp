...
!(function (t, e) {
  ...
  function i(t, e) {
    ...
    for (n in i)
      !$t.test(n) ||
        (t[n] && t[n].fix) ||
        (t[n] = "convert" !== n ? r(t.constructor.prototype[n], i[n]) : i[n]);
  }
  function o(t) {
    return t;
  }
  ...
  function g(t, e, n, r) {
    ...
    if ((1 === n && ((r = 1), (n = void 0)), e))
      for (o = e.split("."), s = o.length; t && l < s; l++)
        (i = t), (t = o[l] ? t[o[l]] : t);
    return (
      n && (n.lt = n.lt || l < s),
      void 0 === t
  ...
  function v(n, r, i) {
    ...
    if (n) {
      ...
      if (
        ((!kt && f.tagCtx) || f.linked) &&
        ((s && s._cxp) ||
          ((f =
            f.tagCtx || st(s)
              ? f
              : ((f = f.scope || f), (!f.isTop && f.ctx.tag) || f)),
          void 0 !== s && f.tagCtx && (f = f.tagCtx.view.scope),
          (v = f._ocps),
          (s = (v && v.hasOwnProperty(n) && v[n]) || s),
          (s && s._cxp) ||
            (!i && !g) ||
            (((v || (f._ocps = f._ocps || {}))[n] = s =
              [{ _ocp: s, _vw: u, _key: n }]),
            (s._cxp = {
              path: Tt,
              ind: 0,
        ...
        if (
          ...
          return s && c !== r && ft._ucp(n, r, f, l), f;
        s = c;
      }
      return (
        s &&
  ...
  function h(t, e, n, r) {
    ...
    return (
      (s = u && e._.onRender ? e._.onRender(s, e, o) : s), void 0 != s ? s : ""
    );
  }
  function _(t, e) {
    var n,
    ...
    if (
      ...
      (l = s.convert) &&
        ...
        (l =
          "true" === l
            ? void 0
            : d.view.getRsc("converters", l) ||
              S("Unknown converter: '" + l + "'")),
      l && !e && (o = o.slice()),
      a)
    ) {
    ...
    if (l) {
      ...
      if (
        ((a = a || [0]),
        (n = a.length),
        (lt(l) && l.length === n) || ((l = [l]), (a = [0]), (n = 1)),
        e)
      )
        o = l;
      else for (; n--; ) (r = a[n]), +r === r && (o[r] = l[n]);
    }
    return o;
  }
  function x(t, e) {
  ...
  function y(t, e, n, r, o, a) {
    ...
    for (
      "tag" === t._is
        ? ((l = t), (t = l.tagName), (r = l.tagCtxs), (p = l.template))
        : ((d = e.getRsc("tags", t) || S("Unknown tag: {{" + t + "}} ")),
          (p = d.template)),
        void 0 === a &&
          G &&
          (G._lr = (d.lateRender && G._lr !== !1) || G._lr) &&
          (a = ""),
        void 0 !== a
          ? ((H += a),
            (r = a = [{ props: {}, args: [], params: { props: {} } }]))
          : G && (r = G(e.data, e, ft)),
        g = r.length;
      B < g;
      B++
      ...
      (y = r[B]),
        (P = y.tmpl),
        (!W || !W.tag || (B && !W.tag.inline) || l._er || (P && +P === P)) &&
          (P && z.tmpls && (y.tmpl = y.content = z.tmpls[P - 1]),
          (y.index = B),
          (y.ctxPrm = v),
          (y.render = E),
          (y.cvtArgs = _),
        ...
        (n = y.props.tmpl) &&
          ((y.tmpl = e._getTmpl(n)), (y.content = y.content || y.tmpl)),
        l
          ? W && W.fn._lr && (R = !!l.init)
          : ((l = new d._ctr()),
            (R = !!l.init),
            (l.parent = f = Z && Z.tag),
            (l.tagCtxs = r),
            W && ((l.inline = !1), (W.tag = l)),
            (l.linkCtx = W),
            (l._.bnd = G || W.fn)
              ? ((l._.ths = y.params.props["this"]),
                (l._.lt = r.lt),
                (l._.arrVws = {}))
              : l.dataBoundOnly &&
                S(t + " must be data-bound:\n{^{" + t + "}}")),
        (I = l.dataMap),
        (y.tag = l),
        I && r && (y.map = r[B].map),
        l.flow ||
    ...
    if (!(l._er = a)) {
      for (i(l, r[0]), l.rendering = { rndr: l.rendering }, B = 0; B < g; B++) {
        if (((y = l.tagCtx = r[B]), ($ = y.props), (l.ctx = y.ctx), !B)) {
          if (
            (R && (l.init(y, W, l.ctx), (R = void 0)),
            y.args.length ||
              y.argDefault === !1 ||
              l.argDefault === !1 ||
              ((y.args = F = [y.view.data]), (y.params.args = ["#data"])),
            (T = s("bindTo")),
            void 0 !== l.bindTo && (l.bindTo = T),
            void 0 !== l.bindFrom
              ? (l.bindFrom = s("bindFrom"))
              : l.bindTo && (l.bindFrom = l.bindTo = T),
            (j = l.bindFrom || T),
            (q = T.length),
            (U = j.length),
            l._.bnd &&
              (K = l.linkedElement) &&
              ((l.linkedElement = K = lt(K) ? K : [K]),
              q !== K.length && S("linkedElement not same length as bindTo")),
            (K = l.linkedCtxParam) &&
              ((l.linkedCtxParam = K = lt(K) ? K : [K]),
              U !== K.length &&
                S("linkedCtxParam not same length as bindFrom/bindTo")),
            j)
          )
        ...
        if (((F = l.cvtArgs(B)), l.linkedCtxParam))
          for (
            V = l.cvtArgs(B, 1), m = U, L = l.constructor.prototype.ctx;
            m--;

          )
            (C = l.linkedCtxParam[m]) &&
              ((J = j[m]),
              (A = V[m]),
              (y.ctx[C] = ft._cp(
                L && void 0 === A ? L[C] : A,
                void 0 !== A && x(y.params, J),
                y.view,
                l._.bnd && { tag: l, cvt: l.convert, ind: m, tagElse: B }
              )));
        (N = $.dataMap || I) &&
          (F.length || $.dataMap) &&
          ((M = y.map),
          (M && M.src === F[0] && !o) ||
            (M && M.src && M.unmap(), N.map(F[0], y, M, !l._.bnd), (M = y.map)),
          (F = [M.tgt])),
          (w = void 0),
          l.render &&
            ((w = l.render.apply(l, F)),
            e.linked &&
              w &&
              !Et.test(w) &&
              ((n = { links: [] }),
  ...
  function k(t, e, n, r, i, o, a, s) {
    ...
    (u.content = s),
      ...
      (u.tmpl = i),
      (p = u._ =
        { key: 0, useKey: f ? 0 : 1, id: "" + Jt++, onRender: a, bnds: {} }),
      (u.linked = !!a),
      (u.type = e || "top"),
      ...
      (u.parent = n)
        ? ((u.root = n.root || u),
          ...
          (u.isTop = d.scp),
          (u.scope =
            ((!t.tag || t.tag === n.ctx.tag) && !u.isTop && n.scope) || u),
          d.useKey
            ? ((l[(p.key = "_" + d.useKey++)] = u),
              (u.index = Ht),
              (u.getIndex = c))
            : l.length === (p.key = u.index = o)
            ? l.push(u)
            : l.splice(o, 0, u),
          (u.ctx = t || n.ctx))
        : e && (u.root = u);
    ...
    function o(n) {
      ...
      if ("" + n === n || (n.nodeType > 0 && (a = n))) {
        if (!a)
          ...
          else if (e.fn && !ft.rTmpl.test(n))
            try {
              a = e(n, document)[0];
            } catch (l) {}
        a &&
          ("SCRIPT" !== a.tagName &&
            S(n + ": Use script block, not " + a.tagName),
          i
            ? (n = a.innerHTML)
            : ((o = a.getAttribute(Bt)),
              o &&
                (o !== Qt
                  ...
                  : e.fn && (n = e.data(a)[Qt])),
              (o && n) ||
                ((t = t || (e.fn ? Qt : n)), (n = A(t, a.innerHTML, r, i))),
              (n.tmplName = t = t || o),
              t !== Qt && (dt[t] = n),
              a.setAttribute(Bt, t),
              e.fn && e.data(a, Qt, n))),
  ...
  function N(t, n) {
    ...
    function o(t, e) {
      for (var n, r, i, o, a, s = 0; s < x; s++)
        (i = f[s]),
          (n = void 0),
          i + "" !== i && ((n = i), (i = n.getter), (a = n.parentRef)),
          void 0 === (o = t[i]) &&
            n &&
      ...
      if (e) {
        for (
          ...
          if (((i = u[d]), (a = f[d].parentRef), a && i && i.unmap))
            if (lt(i)) for (n = i.length; n--; ) R(i[n], a, p);
            else R(i, a, p);
    ...
    function s(t, e, n) {
      ...
      if (lt(h)) {
        for (u = {}, f = [], a = t.length, s = h.length; m < a; m++) {
          ...
          p
            ? (d.merge(c), f.push(d))
            : (f.push((g = i.map(c))), n && R(g, n, e));
        }
        return void (b
          ? b(h).refresh(f, !0)
          : h.splice.apply(h, [0, h.length].concat(f)));
      }
    ...
    var d,
      ...
      g = n.extend,
      v = n.id,
      m = e.extend({ _is: t || "unnamed", unmap: l, merge: s }, g),
      h = "",
      _ = "",
      x = f ? f.length : 0,
      b = e.observable,
          ...
          (m[t] =
            ...
            function (n) {
              return arguments.length
                ? void (b ? b(this).setProperty(t, n) : (this[e] = n))
                : this[e];
            }),
          b &&
            (m[t].set =
  ...
  function M(t, n) {
    ...
    return (
      ...
      (o.markup = t),
      o.htmlTag ||
        ((r = Mt.exec(t)), (o.htmlTag = r ? r[1].toLowerCase() : "")),
      (r = i[o.htmlTag]),
  ...
  function F(t, e) {
    function n(i, o, a) {
      ...
      return (
        ...
        (s = e.compile),
        void 0 === o && ((o = s ? i : d[i]), (i = void 0)),
        null === o
          ? i && delete d[i]
          : (s && ((o = s.call(d, i, o, a, 0) || {}), (o._is = t)),
            i && (d[i] = o)),
        p && p(i, o, a, s),
        o
      );
    ...
    if (
      ...
      (l = this.tag)
        ? ((p = this),
          ...
          arguments.length ||
            (t = l.contentCtx && st(l.contentCtx) ? (t = l.contentCtx(t)) : g))
        : (d = this),
      d)
    ) {
      if (
        ...
        if (
          (g
            ? ((c = g.data), (f = g.index), (g.index = Ht))
            : ((g = it), (c = g.data), (g.data = t), (g.ctx = e)),
          lt(t) && !n)
        )
    ...
    if (
      (s &&
        ...
        t === i.content
          ...
          : t !== b.content
          ? t === s.template
            ? ((v = b.tmpl), (n._wrp = b.content))
            : (v = b.content || i.content)
          : (v = i.content),
      ...
      (_ = b && b.props.itemVar) &&
        ("~" !== _[0] && D("Use itemVar='~myItem'"), (_ = _.slice(1))),
      o === !0 && ((g = !0), (o = 0)),
      a && s && s._.noVws && (a = void 0),
      (m = a),
      a === !0 && ((m = void 0), (a = i._.onRender)),
      (n = t.helpers ? Q(t.helpers, n) : n),
      (x = n),
      lt(e) && !r)
    )
      for (
        u = g ? i : (void 0 !== o && i) || new k(n, "array", i, e, t, o, a, v),
          u._.nl = w,
          i && i._.useKey && ((u._.bnd = !s || (s._.bnd && s)), (u.tag = s)),
          l = 0,
          p = e.length;
        l < p;
        l++
  ...
  function I(t, e, n) {
    ...
    return (
      gt.onError &&
        void 0 !== (n = gt.onError.call(e.data, t, n && r, e)) &&
        (r = n),
      e && !e._lc ? pt.html(r) : r
    );
  }
  ...
  function J(t, e, n, r, i) {
    ...
    function s(s, l, d, c, g, x, b, w, y, k, C, T) {
      ...
      (d = d || ((w = w || "#data"), g)),
        ...
        b
          ...
          : d
          ? ("else" === d &&
              (Nt.test(w) && D('For "{{else if expr}}" use "{{else expr}}"'),
              (R = _[9] && [[]]),
              ...
              (S = !0)),
            w &&
              L(w.replace(jt, " "), R, e, n)
                .replace(Rt, function (t, e, n, r, i, o, a, s) {
                  return (
                    "this:" === r && (o = "undefined"),
                    s && (P = P || "@" === s[0]),
                    (r = "'" + i + "':"),
            ...
            h.push(p),
            S && (m.push(_), (_ = p), (_[10] = v), (_[11] = A)))
          : C &&
            (a(C !== _[0] && C !== _[11] && C, _[0]),
            (_[10] = t.substring(_[10], T)),
            (_ = m.pop())),
        a(!_ && C),
        (h = _[2]);
    ...
    if (
      ...
      n &&
        (void 0 !== r && (t = t.slice(0, -r.length - 2) + xt),
        (t = ht + t + bt)),
      a(m[0] && m[0][2].pop()[0]),
      t.replace(rt, s),
      o(t.length),
    ...
    function i(i, p, x, b, w, y, k, C, T, j, A, P, R, N, M, F, V, $, E, O, I) {
      function S(t, n, i, s, l, d, p, f) {
        ...
        if (
          ...
          g ||
            ((t =
              (j ? (r ? "" : "(ltOb.lt=ltOb.lt||") + "(ob=" : "") +
              (s ? 'view.ctxPrm("' + s + '")' : l ? "view" : "data") +
              (j
                ? ")===undefined" + (r ? "" : ")") + '?"":view._getOb(ob,"'
                : "") +
              (f
                ? (d ? "." + d : s ? "" : l ? "" : "." + i) + (p || "")
                : ((f = s ? "" : l ? d || "" : i), ""))),
            ...
            (t =
              n +
              ("view.data" === t.slice(0, 9) ? t.slice(5) : t) +
              (j ? (r ? '"' : '",ltOb') + (A ? ",1)" : ")") : ""))),
          u)
        ) {
          if (
            ((K = "_linkTo" === o ? (a = e._jsvto = e._jsvto || []) : c.bd),
            (L = g && K[K.length - 1]))
          ) {
            if (L._cpfn) {
              for (; L.sb; ) L = L.sb;
      ...
      if (("[" === A && ((A = "[j._sq("), (Q = ")]")), !k || d || l)) {
        if (
          ...
          !l &&
          m &&
          ((U = _[m - 1]), I.length - 1 > O - (U || 0))
        ) {
          if (((U = I.slice(U, O + i.length)), q !== !0))
            if (((K = a || f[m - 1].bd), (L = K[K.length - 1]), L && L.prm)) {
              for (; L.sb && L.sb.prm; ) L = L.sb;
              B = L.sb = { path: L.sb, bnd: L.bnd };
            } else K.push((B = { path: K.pop() }));
          (V = _t + ":" + U + " onerror=''" + xt),
            (q = v[V]),
            q || ((v[V] = !0), (v[V] = q = J(V, n, !0))),
            q !== !0 &&
              B &&
              ((B._cpfn = q),
              (B.prm = c.bd),
          ...
          : (x ? ((_[m] = O++), (c = f[++m] = { bd: [] }), x) : "") +
            (E
              ...
              ? (m && D(t),
                ...
                (s = b),
                (g = O + i.length),
                u && ((u = c.bd = e[o] = []), (u.skp = !b)),
                w + ":")
              : w
              ? w.split("^").join(".").replace(ft.rPath, S) +
                (A ? ((c = f[++m] = { bd: [] }), (h[m] = Q), A) : y)
              : y
              ? y
              : F
              ? ((F = h[m] || F),
  ...
  function B(t, e, n) {
    ...
    for (
      "" + e === e
        ? ((b = n ? 'data-link="' + e.replace(jt, " ").slice(1, -1) + '"' : e),
          (e = 0))
      ...
      if (((i = t[r]), "" + i === i)) J += '\n+"' + i + '"';
        ...
        if (
          ...
          (A = "else" === o)
            ? g && g.push(i[9])
            : ((N = i[5] || (gt.debugMode !== !1 && "undefined")),
              f && (g = i[9]) && ((g = [g]), (I = f.push(1)))),
  ...
  function W(t, n) {
    ...
    if (
      ...
      t.filter &&
        d &&
        ((t = t.filter(d, n)), n.tag.onFilter && n.tag.onFilter(n)),
      l.sorted &&
        ((r = p || f < 0 ? t : t.slice()),
  ...
  if (
    ...
    if (
      ...
      (ut = ot.helpers),
      (ct = ot.tags),
      (ft._tg.prototype = { baseApply: j, cvtArgs: _, bndArgs: b, ctxPrm: v }),
      (it = ft.topView = new k()),
      e)
    ) {
    ...
    (mt.debugMode = function (t) {
      ...
      (vt = gt.advanced = { useViews: !1, _jsv: !1 }),
      ct({
        if: {
          render: function (t) {
            var e = this,
              n = e.tagCtx,
              r =
                e.rendering.done || (!t && (n.args.length || !n.index))
                  ? ""
        ...
        props: { baseTag: "for", dataMap: $(H), init: a, flow: !0 },
        include: { flow: !0 },
        "*": { render: o, flow: !0 },
        ":*": { render: o, flow: !0 },
        dbg: (ut.dbg = pt.dbg = s),
