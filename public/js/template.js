    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/templates/response",
      method: "get",
    };
  ...
  submitForm: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/templates/create",
      method: "post",
      data: formData,
    };
  ...
  deleteRecord: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/templates/destroy/" + ele.data("id"),
      method: "get",
    };
