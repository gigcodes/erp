...
var msQueue = {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/lead-queue/records",
      method: "get",
  ...
  submitForm: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/lead-queue/records/action-handler",
      method: "post",
      data: {
        action: action,
        ids: ids,
  ...
  submitLimit: function (ele) {
    var limit = $(".lead-queue-limit-handler")
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/lead-queue/setting/update-limit",
      method: "post",
  ...
  filterReport: function (href) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/lead-queue/report",
      method: "get",
