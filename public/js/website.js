    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/records",
      method: "get",
  ...
  deleteRecord: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/" + ele.data("id") + "/delete",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  editRecord: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/" + ele.data("id") + "/edit",
      method: "get",
    };
  ...
  submitFormSite: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/save",
      method: "post",
  ...
  push: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/" + ele.data("id") + "/push",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  createDefaultStores: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/create-default-stores",
      method: "post",
      data: {
  ...
  moveStores: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/move-stores",
      method: "post",
      data: {
  ...
  copyStores: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/copy-stores",
      method: "post",
      data: {
  ...
  changeStatus: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/change-status",
      method: "post",
      data: {
        id: ele.data("id"),
  ...
  copyWebsites: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/copy-websites",
      method: "post",
      data: {
  ...
  pushStores: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/" + id + "/push-stores",
      method: "get",
      data: {},
    };
  ...
  copyWebsitesStruct: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/" + id + "/copy-website-struct",
      method: "get",
  ...
  changePriceOvveride: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/websites/change-price-ovveride",
      method: "post",
      data: {
        id: ele.data("id"),
        value: ele.data("value"),
  ...
  afterChangePriceOvveride: function (response, ele) {
    if (response.code == 200) {
      ...
      if (response.data.is_price_ovveride == 1) {
        var html =
          `<span class="badge badge-success change-is_price_ovveride" data-id="` +
          response.data.id +
          `" data-value="0">Yes</span>`;
      } else {
        var html =
          `<span class="badge badge-danger change-is_price_ovveride" data-id="` +
          response.data.id +
