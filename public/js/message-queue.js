...
var msQueue = {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/message-queue/records",
      method: "get",
  ...
  submitForm: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/message-queue/records/action-handler",
      method: "post",
      data: {
        action: action,
        ids: ids,
  ...
  submitLimit: function (ele) {
    var limit = $(".message-queue-limit-handler")
      .find(".message_sending_limit")
      .val();
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/message-queue/setting/update-limit",
      method: "post",
  ...
  submitTime: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/message-queue/setting/update-time",
      method: "post",
  ...
  filterReport: function (href) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/message-queue/report",
      method: "get",
