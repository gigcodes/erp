    ...
    getResults: function(href) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/newsletters/records",
            method: "get",
    ...
    deleteImages : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/newsletters/image/"+ele.data("id")+"/"+ele.data("productid")+"/delete",
            method: "get",
            beforeSend : function() {
                $("#loading-image").show();
            }
    ...
    editRecord : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/newsletters/"+ele.data("id")+"/edit",
            method: "get",
        }
    ...
    submitPlatform : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/newsletters/store",
            method: "post",
    ...
    pushShopifyProduct : function(ele) {
        var _z = {
            url: this.config.baseUrl + "/newsletters/"+ele.data("id")+"/push-to-shopify",
            method: "GET",
            beforeSend : function() {
                $("#loading-image").show();
            }
    ...
    {
        var _z = {
            url: this.config.baseUrl + "/newsletters/"+ele.data("id")+"/change-store",
            method: "GET",
