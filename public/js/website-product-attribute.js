    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/records",
      method: "get",
  ...
  submitFormSite: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/save",
      method: "post",
  ...
  createDefaultStores: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/create-default-stores",
      method: "post",
      data: {
  ...
  moveStores: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/move-stores",
      method: "post",
      data: {
  ...
  changeStatus: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/change-status",
      method: "post",
      data: {
        id: ele.data("id"),
  ...
  copyWebsites: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/product-attribute/copy-websites",
      method: "post",
      data: {
