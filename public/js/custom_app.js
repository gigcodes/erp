...
$(document).on("click", ".sop_search_menu", function(e) {
    ...
    var q = $this;
    $.ajax({
        url: configs.routes.menu_sop_search,
        type: 'GET',
        data: {
            search: q,
        },
...
$(document).on("click", ".email_search_menu", function(e) {
    ...
    var q = $this;
    $.ajax({
        url: configs.routes.menu_email_search,
        type: 'GET',
        data: {
            search: q,
        },
...
$(document).on("click", ".btn-vendor-search-flowchart", function (e) {        
    ...
    if(fc_vendor_id>0){
        ...
        $.ajax({
            url: configs.routes.vendors_flowcharts_search,
            type: 'POST',
            data: {
...
$(document).on("click", ".btn-vendor-search-qa", function (e) {        
    ...
    if(qa_vendor_id>0){
        ...
        $.ajax({
            url: configs.routes.vendors_qa_search,
            type: 'POST',
            data: {
...
$(document).on("click", ".btn-vendor-search-rqa", function (e) {        
    ...
    if(rqa_vendor_id>0){
        ...
        $.ajax({
            url: configs.routes.vendors_rqa_search,
            type: 'POST',
            data: {
...
$(document).on('change', '#keyword_category', function() {
    ...
    if ($(this).val() != "") {
        ...
        $.ajax({
            url: configs.routes.get_store_wise_replies + '/' + category_id + '/' + store_website_id,
            type: 'GET',
            dataType: 'json'
        }).done(function(data) {
            console.log(data);
...
function getScriptDocumentLogs(showModal = false) {
    $.ajax({
        type: "GET",
        url: configs.routes.script_documents_errorlogs,
        dataType:"json",
        beforeSend:function(data){
            $('.ajax-loader').show();
        }
...
function saveRemarksHeaderFc(vendor_id, flow_chart_id){
    ...
    if(remarks==''){
        ...
        $.ajax({
            url: configs.routes.vendors_flowchart_saveremarks,
            type: 'POST',
            headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
...
function checkRecord() {
    $.ajax({
        url: configs.routes.event_getAppointmentRequest, // Replace with your server endpoint
        method: 'GET',
