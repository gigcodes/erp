!(function (m) {
  ...
  var t,
    ...
    vt = function (e) {
      return (
        (e.nodeType !== gt && e.nodeType !== ht) || 0 === e.childElementCount
      );
    },
    bt = function (e, t) {
      return e.dom() === t.dom();
      ...
      generate: function (e) {
        ...
        P(e, function (e, c) {
          ...
          P(e.cells(), function (e, t) {
            ...
            for (
              var r = qt.extended(e.element(), e.rowspan(), e.colspan(), c, n),
                o = 0;
              o < e.colspan();
              o++
            )
      ...
      return (
        ...
        (o = function (e) {
          for (var t = 0; t < e.childNodes.length; t++) {
            if (r(De.fromDom(e.childNodes[t])))
              return S.some(De.fromDom(e.childNodes[t]));
  ...
  var qn = $("left", "right"),
    ...
    Yn = function (n, r, e) {
      return Vn(n, r, e).map(function (e) {
        var t = n.create().clone(r);
        return (
          n.insert().appendAll(t, e.after()), n.insert().after(r, t), qn(r, t)
        );
      });
    },
    Xn = function (i, e, u, a) {
      ...
      return bt(a, c)
        ...
        : Rr(a).bind(function (u) {
            return Rr(c).bind(function (i) {
              if (bt(u, i))
                return S.some(Tr({ boxes: xr(u, a, c), start: a, finish: c }));
              if (wt(u, i)) {
                var e =
                  0 < (t = Gt(c, "td,th", l(u))).length ? t[t.length - 1] : c;
                return S.some(
                  Tr({ boxes: Cr(u, a, u, c, i), start: a, finish: e })
                );
              }
              if (wt(i, u)) {
                var t,
                  n =
                    0 < (t = Gt(a, "td,th", l(i))).length ? t[t.length - 1] : a;
                return S.some(
                  Tr({ boxes: Cr(i, a, u, c, i), start: a, finish: n })
                );
              }
              return lr
                .ancestors(a, c)
                ...
                .bind(function (e) {
                  return un(e, "table", r).bind(function (e) {
                    ...
                    return S.some(
                      Tr({ boxes: Cr(e, a, u, c, i), start: o, finish: n })
                    );
                  });
                });
            });
    ...
    zr = function (n, e) {
      return jr.cata(
        ...
        function (t, e) {
          return 0 === t.length
            ? S.none()
            : Pr(n, Mr.firstSelectedSelector(), Mr.lastSelectedSelector()).bind(
                function (e) {
                  return 1 < t.length
  ...
  var Bo,
    ...
    Ho = function (e) {
      return k(e, function (e) {
        ...
        return (
          P(e.cells(), function (e) {
            var t = Bn(e.element());
            Fo(t, "colspan", e.colspan(), 1),
              Fo(t, "rowspan", e.rowspan(), 1),
              kt(n, t);
          }),
          n
        );
    ...
    Xo = function (e) {
      0 === (qo(e) ? e.dom().classList : Uo(e, "class")).length &&
        ye(e, "class");
    },
    Ko = function (e, t) {
    ...
    Yi = function (e, n, r, o, i) {
      return k(e, function (e) {
        var t =
          0 < n &&
          n < pi.cellLength(e) &&
          o(pi.getCellElement(e, n - 1), pi.getCellElement(e, n))
            ? pi.getCell(e, n)
    ...
    Xi = function (e, r, o, i, u) {
      ...
      return k(e, function (e, t) {
        var n =
          t === r
            ? qt.elementnew(u(pi.getCellElement(e, o), i), !0)
            : pi.getCell(e, o);
    ...
    wa = {
      directionAt: function (e) {
        return "rtl" == ("rtl" === Ie(e, "direction") ? "rtl" : "ltr")
          ? ba
          : va;
      },
    },
              ...
              items: [
                {
                  label: "Width",
                  name: "width",
                  onchange: b(Va.updateStyleField, t),
                },
                {
                  label: "Height",
                  name: "height",
    ...
    ec = function (r, e, t) {
      var n,
        ...
        u = {
          styles: i,
          attributes:
            ((o = r), o.getParam("table_default_attributes", Ca, "object")),
  ...
  function tc(e, t, n, r) {
    if ("TD" === t.tagName || "TH" === t.tagName) e.setStyle(t, n, r);
      ...
      for (var o = 0; o < t.children.length; o++) tc(e, t.children[o], n, r);
  }
      ...
      Ta(e) && Va.syncAdvancedStyleFields(e, n),
        ...
        e.undoManager.transact(function () {
          t || (t = ec(e, o.cols || 1, o.rows || 1)),
            ...
            !r &&
              o.caption &&
              (((r = i.create("caption")).innerHTML = Ja.ie
                ? "\xa0"
                : '<br data-mce-bogus="1"/>'),
              ...
              n(i, e).each(function (e) {
                ...
                (t = a),
                  ...
                  (n.width === o.width && n.height === o.height) ||
                    (Ia(t, r.dom(), n.width, n.height),
                    Ba(t, r.dom(), o.width, o.height)),
  ...
  function Tc(e, n) {
    var r = ko.height,
      ...
      o = lc.create({
        beforeResize: cc(["table"]),
        afterResize: cc(["table"]),
        startDrag: cc([]),
      });
    return (
  ...
  var Dc = function (e, t) {
    ...
    nl = function (t, e, n, r) {
      ...
      return jo(i, function (e) {
        return (
          o.selectNode(e.dom()),
          Zc(o.getBoundingClientRect(), n, r) ? rl(t, e, n, r) : S.none()
        );
      });
    },
    rl = function (e, t, n, r) {
    ...
    ll = document.caretPositionFromPoint
      ...
      : function (o, i, t) {
          return De.fromPoint(o, i, t).bind(function (r) {
            var e = function () {
              return (
                (e = o), (n = i), (0 === Dt((t = r)).length ? al : ul)(e, t, n)
              );
              var e, t, n;
            };
  ...
  function _l(a) {
    return {
      ...
      scrollBy: function (e, t) {
        ...
        (n = e),
          (r = t),
          ((o = De.fromDom(a.document)) !== undefined
            ? o.dom()
            : m.document
  ...
  var Ll = function (n, e, r, t, o) {
    ...
    Vl = function (e, t) {
      return de(t)
        ? Ul(e, t).map(Hl)
        : me(t)
        ? e.getRangedRect(t, 0, t, Dn(t)).map(Hl)
        : S.none();
    },
    Gl = $("item", "mode"),
    Yl = function (e, t, n, r) {
      ...
      return Pf.browser.isIE()
        ...
        : i(r, t).orThunk(function () {
            return Bf(e, t, n, r, o).map(function (e) {
              var t = e.range();
              return Al.response(
                S.some(Ml(t.start(), t.soffset(), t.finish(), t.foffset())),
                !0
              );
            });
          });
  ...
  e.add("table", function (t) {
    ...
    return (
      ...
      t.on("PreInit", function () {
        t.serializer.addTempAttr(Mr.firstSelected()),
          t.serializer.addTempAttr(Mr.lastSelected());
      }),
