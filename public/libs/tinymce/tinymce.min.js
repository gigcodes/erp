...
!(function (H) {
  ...
  (Lt.prototype = _e.filters = _e.pseudos),
    ...
    (Le = Tt.select =
      function (e, t, n, r) {
        ...
        return (
          (c || Pe(e, l))(r, t, !He, n, (Nt.test(e) && Pt(t.parentNode)) || t),
          n
        );
      }),
    (Re.sortStable = We.split("").sort(Ze).join("") === We),
      ...
      V = {
        ...
        getOuterHTML: function (e) {
          ...
          return Bo.isElement(t)
            ? t.outerHTML
            : hn("<div></div>").append(hn(t).clone()).html();
        },
    ...
    Ac =
      ...
      (_s = nr.detect().browser),
      {
        get: function (e) {
          if (!Ts(e))
            throw new Error(
              "Can only get " + As + " value of a " + As + " node"
            );
          return Ds(e).getOr("");
        },
        getOption: (Ds =
  ...
  var Qc,
    ...
    rl = function (e, t, n) {
      ...
      if (
        ...
        !(function (e, t) {
          ...
          A.from(S.getParent(k, "td,th")).map(or.fromDom).each(Xc),
          e.fire("SetContent", s),
          e.addVisual();
      }
    },
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              o && o.external_plugins
                ? Gt.extend({}, o.external_plugins, a)
                : a),
          }
        );
      return dl(e, g, n, p);
          ...
          return (
            ...
            Zs.fromPosition(t, r, i)
              ...
              .fold(
                ...
                function (e) {
                  return ad(n, r, e).map(d(ld, t, n, r, i, e)).filter(d(fd, o));
                }
              )
              .filter(id)
          );
    ...
    Em = function (e, t, n) {
      ...
      if (xm(t)) Lf(e, !1, or.fromDom(t), n);
        ...
        var a = i.getRng(),
          ...
          s =
            ((r = wm(t)) && r.nodeValue.charAt(0) === ym && r.deleteData(0, 1),
            r);
        a.startContainer === s &&
          0 < a.startOffset &&
    ...
    Jg = function (e, t) {
      return A.from(t).filter(Wg(e)).map(qg);
    },
    Qg = function (e) {
    ...
    op = function (e) {
      return z(W(e.selection.getSelectedBlocks(), or.fromDom), function (e) {
        return !rp(e) && !Mr(e).map(rp).getOr(!1);
      });
    },
    ip = function (e, t) {
      var n = e.settings,
      ...
      r.collapsed ||
        ...
        Kv(
          ...
          function (e) {
            ...
            (t = e.previousSibling),
              hn((n = e)).remove(),
              hn(t).append("<br><br>").append(n.childNodes);
          }
        ));
  }),
    $v[(jv = "pre")] || ($v[jv] = []),
  ...
  var Gy = function (e, t) {
    ...
    $x = function (e, t) {
      var n,
        r =
          ((n = e),
          Yi(or.fromDom(n.getBody()), "*[data-mce-caret]").fold(
            q(null),
            function (e) {
              return e.dom();
            }
  ...
  var Qx = function (e) {
    ...
    rw = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        (t.parser =
          ((o = oy((u = t).settings, u.schema)).addAttributeFilter(
