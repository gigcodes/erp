  ...
  $("#pma_navigation_tree")
    ...
    .each(function () {
      if (
        ...
        $(this).closest("li").find("div.list_container .ic_b_minus").length ===
          0
      ) {
...
$(function () {
  ...
  $(document).on(
    "click",
    "#pma_navigation_tree li.fast_filter button.searchClauseClear",
  ...
  $(document).on(
    "click",
    "#pma_navigation_tree div.pageselector a.ajax",
    function (event) {
      event.preventDefault();
  ...
  $(document).on(
    "click",
    "#pma_navigation_tree li.new_index a.ajax",
    function (event) {
      event.preventDefault();
      var url =
        $(this)
...
Navigation.showCurrent = function () {
      ...
      if (
        ...
        Navigation.loadChildNodes(
          ...
          function () {
            ...
            var $children = $("#pma_navigation_tree_content").children(
              "div.list_container"
            );
            $children.promise().done(Navigation.treeStateUpdate);
          }
  ...
  function loadAndHighlightTableOrView($dbItem, itemName) {
    ...
    if ($whichItem) {
      ...
      showTableOrView(
        $whichItem,
        $relatedContainer.children("div").first().children("a.expander")
      );
...
Navigation.treePagination = function ($this) {
  ...
  if ($this[0].tagName === "A") {
    ...
    // tagName === 'SELECT'
    params +=
      CommonParams.get("arg_separator") + $this.closest("form").serialize();
  }
...
Navigation.ResizeHandler = function () {
  ...
  this.setWidth = function (position) {
    ...
    $("#floating_menubar")
      .css(
        "margin-" + this.left,
        $("#pma_navigation").width() + $("#pma_navigation_resizer").width()
      )
      .css(this.left, 0)
      .css({
        position: "fixed",
