...
AJAX.registerOnload("keyhandler.js", function () {
  $("th.draggable.column_heading.pointer.marker a").on(
    "click",
    function (event) {
      var orderUrlRemove = $(this)
        .parent()
        .find('input[name="url-remove-order"]')
        .val();
      var orderUrlAdd = $(this)
        .parent()
        .find('input[name="url-add-order"]')
        .val();
      ...
      if (event.ctrlKey || event.altKey) {
        ...
        orderUrlRemove +=
          argsep + "ajax_request=true" + argsep + "ajax_page_request=true";
