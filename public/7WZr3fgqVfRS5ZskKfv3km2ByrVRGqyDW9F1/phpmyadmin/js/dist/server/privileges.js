    ...
    $.get(
      ...
      (data) => {
        ...
        saveButton.addEventListener("click", () => {
          const form = $(
            editUserGroupModal.querySelector("#changeUserGroupForm")
          );
          $.post(
            ...
            (data) => {
              ...
              const userGroup = form
                .serializeArray()
                .find((el) => el.name === "userGroup").value; // button -> td -> tr -> td.usrGroup

              const userGroupTableCell =
                button.parentElement.parentElement.querySelector(".usrGroup");
