        ...
        if (g.currentEditCell) {
          ...
          if (isNull) {
            ...
            var value = data.isNeedToRecheck
              ...
              : $thisField.data("value"); // Truncates the text.
        ...
        if ($td.is(".relation")) {
          ...
          g.lastXHR = $.post(
            ...
            function (data) {
              ...
              $editArea.append(
                '<div class="cell_edit_hint">' + g.cellEditHint + "</div>"
          ...
          if ($td.is(".to_be_saved")) {
            ...
            var sqlQuery =
              ...
              g.table +
              "` WHERE " +
              whereClause; // Make the Ajax call and get the data, wrap it and insert it
          ...
          $td.is(".timefield, .datefield, .datetimefield, .timestampfield")
        ) {
              ...
              for (var field in conditionArray) {
                if (field.indexOf(fieldStr) > -1) {
                  conditionArray[field] = isNull
                    ? "IS NULL"
                    : "= '" +
                      thisFieldParams[fieldName].replace(/'/g, "''") +
                      "'";
                  break;
                }
              }
          ...
          if (typeof data !== "undefined" && data.success === true) {
              ...
              .each(function () {
                ...
                $(this)
                  ...
                  .each(function () {
                    $(this).attr(
                      "href",
                      $(this).attr("href").replace(oldClause, newClause)
                ...
                $(this)
                  ...
                  .each(function () {
                    ...
                    $checkbox.attr(
                      "name",
                      checkboxName.replace(oldClause, newClause)
                    );
                    $checkbox.val(
                      checkboxValue.replace(decodedOldClause, decodedNewClause)
                    );
                  });
            ...
            if (typeof data.sql_query !== "undefined") {
              ...
              var tools = $resultQuery
                ...
                .wrap("<p>")
                .parent()
                .html(); // sqlOuter and tools will not be present if 'Show SQL queries' configuration is off
