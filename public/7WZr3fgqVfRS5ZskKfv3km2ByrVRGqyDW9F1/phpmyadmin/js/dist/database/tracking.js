...
AJAX.registerTeardown("database/tracking.js", function () {
  $("body").off(
    "click",
    '#trackedForm.ajax button[name="submit_mult"], #trackedForm.ajax input[name="submit_mult"]'
  );
  $("body").off(
    "click",
    '#untrackedForm.ajax button[name="submit_mult"], #untrackedForm.ajax input[name="submit_mult"]'
  );
