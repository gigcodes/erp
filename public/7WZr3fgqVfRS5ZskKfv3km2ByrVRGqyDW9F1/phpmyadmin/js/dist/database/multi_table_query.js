...
AJAX.registerOnload("database/multi_table_query.js", function () {
  ...
  $("#submit_query").on("click", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $resultsDom
          .find(".autosubmit, .pageselector, .showAllRows, .filter_rows")
          .each(function () {
  ...
  $("#add_column_button").on("click", function () {
    ...
    $newColumnDom
      ...
      .first()
      .attr("data-bs-target", "#criteriaOptionsExtra" + columnCount.toString());
    $newColumnDom
      .find(".jsCriteriaButton")
      .first()
      .attr("aria-controls", "criteriaOptionsExtra" + columnCount.toString());
    $newColumnDom
  ...
  function addNewColumnCallbacks() {
    $(".tableNameSelect").each(function () {
      $(this).on("change", function () {
        ...
        $sibs
          .first()
          .html($("#" + $(this).find(":selected").data("hash")).html());
      });
    });
