        ...
        <table class="table table-bordered"style="table-layout:fixed;">
            <thead>
              <tr>
                ...
                <th width="15%">Original Content</th>
            ...
            <tbody>
                {{props data}} 
                  <tr>
                    ...
                    <td class="Website-task" title="{{:prop.original_page.content}}">{{:prop.original_page.content}}</td>
                    <td class="Website-task" title="{{:prop.content}}">{{:prop.content}}</td>
