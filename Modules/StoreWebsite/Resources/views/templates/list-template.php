					    ...
					    <tbody>
					    	{{props data}}
						      <tr>
						        ...
						        <td>{{:prop.created_at}}</td>
						        <td>
						        	<button type="button" data-store-website-id="{{>prop.store_website_id}}" data-id="{{>prop.id}}" class="btn btn-delete-store-website-brand"><img width="15px" title="Delete" src="/images/delete.png"></button>
						        </td>
						      </tr>
						    {{/props}}  
					    </tbody>
