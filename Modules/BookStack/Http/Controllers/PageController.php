...
class PageController extends Controller
{
    ...
    public function editDraft($bookSlug, $pageId)
    {
        ...
        return view('bookstack::pages.edit', [
            'page' => $draft,
            'book' => $draft->book,
            'isDraft' => true,
    ...
    public function show($bookSlug, $pageSlug)
    {
        ...
        return view('bookstack::pages.show', [
    ...
    public function saveDraft(Request $request, $pageId)
    {
        ...
        if (!$this->signedIn) {
            return response()->json([
                'status' => 'error',
                'message' => trans('bookstack::errors.guests_cannot_save_drafts'),
            ], 500);
        }
        ...
        return response()->json([
            'status'    => 'success',
            'message'   => trans('bookstack::entities.pages_edit_draft_save_at'),
    ...
    public function showDelete($bookSlug, $pageSlug)
    {
        ...
        $this->setPageTitle(trans('bookstack::entities.pages_delete_named', ['pageName'=>$page->getShortName()]));
        return view('bookstack::pages.delete', ['book' => $page->book, 'page' => $page, 'current' => $page]);
    }
    ...
    public function showDeleteDraft($bookSlug, $pageId)
    {
        $page = $this->pageRepo->getById('page', $pageId, true);
        $this->checkOwnablePermission('page-update', $page);
        $this->setPageTitle(trans('bookstack::entities.pages_delete_draft_named', ['pageName'=>$page->getShortName()]));
        return view('bookstack::pages.delete', ['book' => $page->book, 'page' => $page, 'current' => $page]);
    }
    ...
    public function destroy($bookSlug, $pageSlug)
    {
        ...
        session()->flash('success', trans('bookstack::entities.pages_delete_success'));
    ...
    public function destroyDraft($bookSlug, $pageId)
    {
        ...
        $book = $page->book;
        $this->checkOwnablePermission('page-update', $page);
        session()->flash('success', trans('bookstack::entities.pages_delete_draft_success'));
        $this->pageRepo->destroyPage($page);
        return redirect($book->getUrl());
    }
    ...
    {
        $page = $this->pageRepo->getPageBySlug($pageSlug, $bookSlug);
        $this->setPageTitle(trans('bookstack::entities.pages_revisions_named', ['pageName'=>$page->getShortName()]));
        return view('bookstack::pages.revisions', ['page' => $page, 'current' => $page]);
    }
    ...
    public function showRevision($bookSlug, $pageSlug, $revisionId)
    {
        ...
        $this->setPageTitle(trans('bookstack::entities.pages_revision_named', ['pageName' => $page->getShortName()]));

        return view('bookstack::pages.revision', [
            'page' => $page,
            'book' => $page->book,
            'diff' => null,
            'revision' => $revision
    ...
    public function destroyRevision($bookSlug, $pageSlug, $revId)
    {
        ...
        if (intval($currentRevision->id) === intval($revId)) {
            session()->flash('error', trans('bookstack::entities.revision_cannot_delete_latest'));
            return response()->view('pages.revisions', ['page' => $page, 'book' => $page->book, 'current' => $page], 400);
        }

        $revision->delete();
        session()->flash('success', trans('bookstack::entities.revision_delete_success'));
    ...
    public function showRecentlyUpdated()
    {
        ...
        return view('bookstack::pages.detailed-listing', [
            'title' => trans('bookstack::entities.recently_updated_pages'),
            'pages' => $pages
        ]);
    }
    ...
    public function showMove($bookSlug, $pageSlug)
    {
        ...
        $this->checkOwnablePermission('page-update', $page);
        $this->checkOwnablePermission('page-delete', $page);
        return view('bookstack::pages.move', [
            'book' => $page->book,
            'page' => $page
        ]);
    }
    ...
    public function move($bookSlug, $pageSlug, Request $request)
    {
        ...
        try {
            ...
            session()->flash(trans('bookstack::entities.selected_book_chapter_not_found'));
        ...
        session()->flash('success', trans('bookstack::entities.pages_move_success', ['parentName' => $parent->name]));
    ...
    public function showCopy($bookSlug, $pageSlug)
    {
        ...
        return view('bookstack::pages.copy', [
            'book' => $page->book,
            'page' => $page
        ]);
    }
    ...
    public function copy($bookSlug, $pageSlug, Request $request)
    {
        ...
        session()->flash('success', trans('bookstack::entities.pages_copy_success'));
    ...
    public function showPermissions($bookSlug, $pageSlug)
    {
        ...
        return view('bookstack::pages.permissions', [
            'page'  => $page,
            'roles' => $roles
        ]);
    }
    ...
    public function permissions($bookSlug, $pageSlug, Request $request)
    {
        ...
        session()->flash('success', trans('bookstack::entities.pages_permissions_success'));
        return redirect($page->getUrl());
    }
}
