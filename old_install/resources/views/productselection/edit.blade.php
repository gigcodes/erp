    ...
    <form action="{{ route('productselection.update',$productselection->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                ">
                    <p>
                    <img src="{{ $productselection->getMedia(config('constants.media_tags'))->first()
                                ? $productselection->getMedia(config('constants.media_tags'))->first()->getUrl() : '' }}"
                         class="img-responsive" style="max-width: 200px;"  alt="">
                    <input type="text" hidden name="oldImage" value="0">
                    </p>
                    <button class="btn btn-primary removeOldImage" data-id="">Remove</button>
                </div>
