...
//            $user_ids[] = $user_roles;
    ...
    public static function getQueueName($flip = false)
    {
        ...
        $mainQueue = [
            'default','product','magento','mageone','magetwo','magethree','supplier_products','customer_message','watson_push','email','high','image_search','command_execution','failed_magento_job'
        ];
