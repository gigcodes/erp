    ...
    public function handle()
    {
        ...
        foreach ($scrapers as $scrapperDetails) {
            ...
            if ($hasAssignedIssue != null) {
                ...
                ScrapLog::create(['scraper_id' => $scrapperDetails->id, 'log_messages' => "Scraper didn't Run In Last 24 Hr"]);
                try {
                ...
                ScrapLog::create(['scraper_id' => $scrapperDetails->id, 'log_messages' => "Not assigned to any user"]);
            }
