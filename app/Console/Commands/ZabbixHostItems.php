        ...
        if (! is_null($get_hosts)) {
            foreach ($get_hosts as $host) {
                ...
                if (! empty($item_interrupt)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'interrupts_per_second' => $item_interrupt->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_free_inode)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'free_inode_in' => $item_free_inode->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_space_utilization)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'space_utilization' => $item_space_utilization->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_total_space)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'total_space' => $item_total_space->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_used_space)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'used_space' => $item_used_space->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_available_memory)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'available_memory' => $item_available_memory->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                $item_available_memory_in = $this->item_api($auth_key, $host->hostid, 'Available Memory in');
                if (! empty($item_available_memory_in)) {
                    ZabbixHistory::create(['host_id' => $host->hostid, 'available_memory_in' => $item_available_memory_in->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_cpu_idle_time)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'cpu_idle_time' => $item_cpu_idle_time->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
                ...
                if (! empty($item_cpu_utilization)) {
                    ...
                    ZabbixHistory::create(['host_id' => $host->hostid, 'cpu_utilization' => $item_cpu_utilization->lastvalue, 'item_id' => $item_interrupt->itemid]);
                }
            }
        }
    }
