...
class MediaController extends Controller
{
    ...
    public function files(Request $request)
    {
        ...
        foreach ($allMedia as $media) {
            $item[] = ['id' => $media->id, 'file_name' => $media->filename, 'mime_type' => $media->mime_type, 'size' => $media->size, 'thumb' => $media->getUrl(), 'original' => $media->getUrl(), 'sitename' => ''];
        }
        ...
        foreach ($websites as $website) {
            ...
            foreach ($webMedia as $media) {
                $item[] = ['id' => $media->id, 'file_name' => $media->filename, 'mime_type' => $media->mime_type, 'size' => $media->size, 'thumb' => $media->getUrl(), 'original' => $media->getUrl(), 'sitename' => $website->website->title];
            }
        }
