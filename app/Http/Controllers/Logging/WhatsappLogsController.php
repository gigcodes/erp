...
class WhatsappLogsController extends Controller
{
  ...
  public function resend($number, $whatsapp_number = null, $message = null, $file = null, $chat_message_id = null, $enqueue = 'opportunistic', $customer_id = null){
    $x = app('App\Http\Controllers\WhatsAppController')->sendWithThirdApi($number, $whatsapp_number, $message, $file, $chat_message_id, $enqueue, $customer_id);
    return $x;
  }
