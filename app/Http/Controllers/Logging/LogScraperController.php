...
class LogScraperController extends Controller
{
    ...
    {
        $apilogs = \App\ScrapApiLog::select('scrap_api_logs.*','scrap_api_logs.scraper_id')->leftJoin('scrapers', 'scrap_api_logs.scraper_id', '=', 'scrapers.id')->select('scrap_api_logs.*','scrapers.scraper_name')->paginate(30);
