					  ...
					  <div class="row">
				  		<div class="col">
				  			<div class="form-group">
							    ...
							    <?php echo Form::text("hs_code",request("hs_code"),["class"=> "form-control","placeholder" => "Enter hs code"]) ?>
						  	</div>
						  	<div class="form-group">
							    <label for="hs_code">Origin Country:</label>
							    <?php echo Form::select("origin_country",\App\SimplyDutyCountry::getSelectList(),request("origin_country"),[
							    	"class"=> "form-control",
