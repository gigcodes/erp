      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th width="10%">downloads</th> <th width="10%">re_downloads</th> <th width="10%">uninstalls</th> <th width="10%">updates</th> <th width="10%">returns</th> <th width="10%">net_downloads</th> <th width="10%">promos</th> <th width="10%">revenue</th> <th width="10%">returns_amount</th> <th width="10%">edu_downloads</th> <th width="10%">gifts</th> <th width="10%">gift_redemptions</th> <th width="10%">edu_revenue</th> <th width="10%">gross_revenue</th> <th width="10%">gross_returns_amount</th> <th width="10%">gross_edu_revenue</th> <th width="10%">business_downloads</th> <th width="10%">business_revenue</th> <th width="10%">gross_business_revenue</th> <th width="10%">standard_downloads</th> <th width="10%">standard_revenue</th> <th width="10%">gross_standard_revenue</th> <th width="10%">app_downloads</th> <th width="10%">app_returns</th> <th width="10%">iap_amount</th> <th width="10%">iap_returns</th> <th width="10%">subscription_purchases</th> <th width="10%">subscription_returns</th> <th width="10%">app_revenue</th> <th width="10%">app_returns_amount</th> <th width="10%">gross_app_revenue</th> <th width="10%">gross_app_returns_amount</th> <th width="10%">iap_revenue</th> <th width="10%">iap_returns_amount</th> <th width="10%">gross_iap_revenue</th> <th width="10%">gross_iap_returns_amount</th> <th width="10%">subscription_revenue</th> <th width="10%">subscription_returns_amount</th> <th width="10%">gross_subscription_revenue</th> <th width="10%">gross_subscription_returns_amount</th> <th width="10%">pre_orders</th>
