<div class="customer-count customer-list-{{$suggested_products_id}} customer-{{$suggested_products_id}}" style="padding: 0px 10px;">   
        ...
        <div class="col-md-12"> 
        <button type="button" class="btn btn-image sendImageMessage pull-right" data-id="{{$customer_id}}" style="padding:0px;margin:0px;"><img src="/images/filled-sent.png" /></button>
        </div>
        </div>
         @endif
        @else
