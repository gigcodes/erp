 ...
 <div id="myDiv">
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="">
                ...
                <!--roletype-->
                <h2 class="page-heading">Image Approval to Message (<span id="products_count">{{ $products_count }}</span>) @if($customerId != null) 
            ...
            <!--Product Search Input -->
                <form action="{{ url()->current() }}" method="GET" id="searchForm" class="form-inline align-items-start">
                    ...
                    <div class="form-group mr-3 mb-3">
                        ...
                        <input type='hidden' name="get_customer_id" value='{{$_GET['customer_id'] ?? $_GET['get_customer_id']}}'>
                    ...
                    <div class="form-group mr-3">
                        ...
                        @endphp
                        <select class="form-control select-multiple multiselect-supplier" name="supplier[]" multiple data-placeholder="Supplier...">
                    ...
                    <div class="form-group mr-3">
                        <input name="size" type="text" class="form-control size-input"
                               value="{{ request('size') }}"
                               placeholder="Size">
                    </div>
                     <div class="form-group mr-3">
                        <select class="form-control select-multiple quick-sell-multiple" name="quick_sell_groups[]" multiple data-placeholder="Quick Sell Groups...">
            ...
            <div class="row mt-3">
                <div class="col-1">
                        <form action="{{ url()->current() }}" method="GET" id="quickProducts" class="form-inline align-items-                        star                        t">
    ...
    <script>
        ...
        $(document).on('click', '#sendImageMessage', function () {
            ...
            for (i = 0; i < $('.select-pr-list-chk').length; i++) {
             var $input = $('.select-pr-list-chk').eq(i);
