          ...
          <div class="col-md-4">
            ...
            <div class="col-md-6">
                    ...
                    <strong>Customer Name:</strong>
                      <input type="text" name="from_customer_name" id="from_customer_name" class="form-control input_customer_name" value="" required>
                    ...
                    <input type="text" name="from_customer_country" id="from_customer_country" class="form-control input_customer_country" value="" required>
                    </div>
                    <div class="form-group mb-2">
