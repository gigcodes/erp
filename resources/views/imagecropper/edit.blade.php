    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('productimagecropper.index') }}"> Back</a>
            </div>
        </div>
    </div>
        ...
        <?php $i = 0 ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                @endif
                    ...
                    <a href="{{$images[$i]->getUrl()}}" download=""><button type="button" class="btn btn-primary" >Download</button></a>
