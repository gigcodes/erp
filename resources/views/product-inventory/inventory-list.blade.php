    ...
    <div class="col-lg-12 margin-tb mb-5 p-0 d-flex">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group mr-pd d-flex align-items-center">
                ...
                {!! Form::select('size_system',["" => "Select status"] + \App\Helpers\StatusHelper::getStatus(), request("status"), ['data-placeholder' => 'Select status','class' => 'form-control change-status col-md-4']) !!}
            </div>
        </div>
