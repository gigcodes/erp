                                ...
                                <td style="word-break: break-all; word-wrap: break-word">
                                    ...
                                    @if ($product->hasMedia(config('constants.media_tags')))
                                        <a href="{{ route('products.show', $product->id) }}" target="_blank">
                                            <img src="{{ \App\Helpers\CommonHelper::getMediaUrl($product->getMedia(config('constants.media_tags'))->first()) }}" class="quick-image-container img-responive" style="width: 70px;" alt="" data-toggle="tooltip" data-placement="top" title="ID: {{ $product->id }}">
                                        </a>
                                    @else
                  ...
                  <input type="number" name="dmeasurement" class="form-control mt-1" placeholder="Depth" min="0" max="999" value="{{ $product->dmeasurement }}">
                            ...
                            @else
                                <td>
                                    ...
                                    @if ($product->hasMedia(config('constants.media_tags')))
                                        <a href="{{ route('products.show', $product['id']) }}" target="_blank">
                                            <img src="{{ \App\Helpers\CommonHelper::getMediaUrl($product->getMedia(config('constants.media_tags'))->first()) }}" class="quick-image-container img-responive" style="width: 100px;" alt="" data-toggle="tooltip" data-placement="top" title="ID: {{ $product['id'] }}">
                                        </a>
                                    @else
