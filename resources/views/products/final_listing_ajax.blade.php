...
<table class="table table-bordered table-striped" style="table-layout:fixed;">
    ...
    <tbody>
        ...
        <tr id="product_{{ $product->id }}" class="">
            ...
            <td>{{ $product->brands ? $product->brands->name : 'N/A' }}</td>
            ...
            <td class="table-hover-cell quick-edit-description" data-id="{{ $product->id }}">
                @if (!$imageCropperRole)
                    ...
                    <textarea name="description" id="textarea_description_{{ $product->id }}" class="form-control quick-edit-description-textarea hidden" rows="8" cols="80">{{ $product->short_description }}</textarea>
                @else
