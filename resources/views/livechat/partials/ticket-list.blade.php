...
<tr>
    ...
    <td>{{ $ticket->email }}</td>
    <td><a href="javascript:void(0)" class="subject1_<?=$ticket->ticket_id?>">{{ substr($ticket->subject,0,6) }}</a></td>
    <td><a href="javascript:void(0)" class="message1_<?=$ticket->ticket_id?>">{{ substr($ticket->message,0,6) }}</a></td>
    ...
    <script type="text/javascript">
       $(document).on('click', '.subject1_<?=$ticket->ticket_id?>', function () {
    ...
    <script type="text/javascript">
       $(document).on('click', '.message1_<?=$ticket->ticket_id?>', function () {
