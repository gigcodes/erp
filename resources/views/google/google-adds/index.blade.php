        ...
        <div class="col-xs-12">
            <form class="form-search-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group cls_task_subject">
                            <input type="text" name="term" placeholder="Location" id="keyword_search" class="form-control input-sm" value="">
                        </div>
                    </div>
                    <!-- Language Selection -->
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group cls_task_subject">
                            <input type="text" name="term" placeholder="Language" id="keyword_search" class="form-control input-sm" value="">
                        </div>
                    </div>
                    <!-- Search Network -->
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group cls_task_subject">
                            <input type="text" name="term" placeholder="Search Network" id="keyword_search" class="form-control input-sm" value="">
                        </div>
                    </div>
                    <!-- Search Bar  -->
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group cls_task_subject">
                            <input type="text" name="term" placeholder="Search product" id="keyword_search" class="form-control input-sm" value="">
                        </div>
                    </div>
                </div>
                <!-- FILTERS -->
                ...
                <div class="row" style="margin:0px;"> 
                    ...
                    <div class="col-12">
                        <table class="table table-sm table-bordered">
                            <thead>
                            <tr>
                                <th width="5%">Kewords</th>
                                <th width="8%">Avg. Search Volume</th>
                                <th width="6%">Competition</th>
                                <th width="10%">For Ads Costing</th>
                            </tr>
                            </thead>
