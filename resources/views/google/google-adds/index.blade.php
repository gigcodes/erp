                ...
                <div class="col-md-3 pd-2">
                    <div class="form-group cls_task_subject border">
                        ...
                        <div class="tablesorter-header-inner">
                            <input type="checkbox" class="show-finished-task" name="google_search" id="google_search"
                                   value="true" checked>
                            <label>Google Search</label>
                        </div>
                        <div class="tablesorter-header-inner">
                            <input type="checkbox" class="show-finished-task" name="search_network" id="search_network"
                                   value="true">
                            <label>Search Network</label>
                        </div>
                        <div class="tablesorter-header-inner">
                            <input type="checkbox" class="show-finished-task" name="content_network"
                                   id="content_network" value="true">
                            <label>Content Network</label>
                        </div>
                        <div class="tablesorter-header-inner">
                            <input type="checkbox" class="show-finished-task" name="partner_search_network"
                                   id="partner_search_network" value="true">
...
<div id="exTab2" style="overflow: auto">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#keyword_language, #keyword_location, #view_type, #google_search, #search_network, #content_network, #partner_search_network, #filter_by_gender').change(function () {
