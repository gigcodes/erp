<div id="columnvisibilityList" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('google.bigdata.column.update') }}" method="POST" id="postman-column-update">
                @csrf
                <div class="form-group col-md-12" style="max-height: 500px; overflow:scroll;">
