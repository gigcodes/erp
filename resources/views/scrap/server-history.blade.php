                              ...
                              <td class="p-2">
                                  <?php
                                    if(isset($listOfServerUsed[$k]) && isset($listOfServerUsed[$k][$totalServer])) {
                                        ...
                                        foreach($loops as $l) {
                                            echo '<span class="badge badge-secondary">'.$l['scraper_name']." ".$l['memory_string'].'&nbsp;<i data-server-id="'.$s.'" data-p-id="'.$l['pid'].'" class="fa fa-window-close stop-job" aria-hidden="true"></i></span><br>';
                                        }
                                    }
                                  ?>
                              </td>
