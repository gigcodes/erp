                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="pull-right">
                                                <button type="button" class="btn btn-xs btn-image comment-it" data-id="{{$comment->instagramPost->id}}" data-post-id="{{$comment->instagramPost->post_id}}" data-hashtag="@if(isset($comment->instagramPost->hashTags->hashtag)){{ $comment->instagramPost->hashTags->hashtag }}@endif"><img src="/images/filled-sent.png" ></button>
                                            </div>
