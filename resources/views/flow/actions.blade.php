...
@foreach($flowActions as $flowAction)
		...
		@elseif($flowAction['type'] == 'Condition') 
			<div class="col-md-12 cross cross_first yes_no_conditions bg-light pt-3 pb-3  m-0" data-type="condition" id="collector_{{$flowAction['id']}}" data-action_id="{{$flowAction['id']}}">
				<input type="hidden" name="action_id[]" value="{{$flowAction['id']}}">
				...
				<div class="col-md-12 erp_yes_no_condition mt-0"> 
