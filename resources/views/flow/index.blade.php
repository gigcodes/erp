				...
				<div class="modal-body">
					<div class="row">
						{{ Form::open(array('url'=>route('flow-create'), 'id'=>'flow-create', 'class'=>'ajax-submit w-100')) }}
							...
							<div class="col-md-3">
								{{ Form::select('flow_name', ['add_to_cart'=>'Add to cart', 'wishlist'=>'Wish List', 'delivered_order'=>'Delivered order', 'newsletters'=>'Newsletters', 'customer_post_purchase'=>'Customer post purchase', 'customer_win_back'=>'Customer Win Back', 'attach_images_for_product'=>'Attach images for product', 'dispatch_send_price'=>'Dispatch send price', 'new_erp_lead'=>'New Erp Lead', 'out_of_stock_subscribe'=>'Out of stock subscribe' , 'payment_failed'=>'Payment Failed'], null, array('class'=>'form-control','placeholder'=>'Flow Name')) }}
							</div>
							<div class="col-md-4">
