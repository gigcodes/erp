                    ...
                    <table cellpadding="0" cellspacing="0" border="1" class="table table-bordered">
                        ...
                        <div id="columnVisibilityControls">
                            ...
                            <tr>
                                <td>Properties</td>
                                <td>
                                    <input type="checkbox" value="Properties" id="Properties" name="column_scrapper[]" @if (!empty($dynamicColumnsToShowscrapper) && in_array('Properties', $dynamicColumnsToShowscrapper)) checked @endif>
                                </td>
                            </tr>
                            <tr>
                                <td>Currency</td>
