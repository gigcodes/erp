        ...
        @foreach ($products as $product)
            <div class="col-md-3 col-xs-6 text-center mb-5">
                  <a href="javascript:;" class="js-open-frm" data-id="{{$product->id}}">
                      <img src="{{ $product->getMedia(config('constants.media_tags'))->first() ? getMediaUrl($product->getMedia(config('constants.media_tags'))->first()) : '' }}" class="img-responsive grid-image" alt="" />
