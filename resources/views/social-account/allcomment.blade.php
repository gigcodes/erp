        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th width="12%">Comment Original</th>
                    <th width="12%">Comment With Translation</th>
            ...
            <tbody>
                @forelse($comments as $key => $value)
                    <tr>
                        ...
                        <td>{{ $value->bussiness_post->bussiness_social_configs->bussiness_website->title }}</td>
                        <td>{{ $value->bussiness_post->bussiness_social_configs->platform }}</td>
                        <td style="width:50%">
                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="w-25 pl-2" role="group" aria-label="First group">
                                        <button type="button" class="btn btn-sm m-0 p-0 mr-1 btn-image send-message1"
                                            data-id="textareaBox_{{ $value->comment_id }}" data-post_id="{{ $value->social_contact_id }}">
