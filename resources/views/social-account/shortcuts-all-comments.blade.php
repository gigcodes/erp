...
<div class="row">
    ...
    <div class="col-6 d-inline form-inline" style="padding-left: 0px;">
        <div style="float: left; width: 86%">
            <select name="quickSubCategory" class="form-control quickSubCategory" data-id="{{$value->comment_id}}">
...
<div class="row">
    ...
    <div class="col-6 d-inline form-inline" style="padding-left: 0px;">
        <div style="float: left; width: 86%">
            <select name="quickComment" class="form-control quickCommentEmail" data-id="{{$value->comment_id}}">
