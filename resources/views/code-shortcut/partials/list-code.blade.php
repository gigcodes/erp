	...
	<tr>
		...
		<td>
			<a class="btn btn-image edit_modal" data-id="{{$code->id}}" data-code="{{$code->code}}" data-des="{{$code->description}}" data-supplier="{{$code->supplier_id}}" data-title="{{$code->title}}" data-solution="{{$code->solution}}"  data-platformId="{{$code->code_shortcuts_platform_id}}" ><img src="/images/edit.png" style="cursor: default; width: 16px;"></a>
