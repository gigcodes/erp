    ...
    <div class="col-md-12">
        <div class="row row_next_action">
            <div class="col-6 form-inline pr-0 m-0">
                ...
                <button class="btn btn-xs text-dark add_next_action w-25 m-0"><i class="fa fa-plus"></i></button>
            </div>
            <div class="col-6 form-inline orm-inline pl-0 m-0">
                ...
                <a class="btn btn-xs delete_next_action w-25 m-0"><i class="fa fa-trash"></i></a>
            </div>
        </div>
    </div>
