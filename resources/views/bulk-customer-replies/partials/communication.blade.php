			...
			<div class="col-md-12">
				<div class="col-md-12 form-inline">
                    ...
                    @if(count($customer->dnd) == 0)
                        <button type="button" class="btn btn-xs btn-image add_to_dnd" data-customer_id="{{$customer->id}}">
                            <img src="/images/do-not-disturb.png"/></button>
                        </button>
                    @else
                        <button type="button" class="btn btn-xs btn-image remove_from_dnd" data-customer_id="{{$customer->id}}">
