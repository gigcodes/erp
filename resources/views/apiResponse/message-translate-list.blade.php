    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="update-translation-submit-form" action="<?php echo route('api-response-message.messageTranslateApprove') ?>" method="post">
                    {{ csrf_field() }}    
                    ...
                    <div class="form-group pull-right">
                        <input id="translation-update-form-submit" class="btn btn-secondary" type="submit" value="Approve">
                    </div>
               </form> 
           </div>
        </div>
