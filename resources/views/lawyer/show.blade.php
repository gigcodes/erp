          ...
          <div class="col-xs-12">
            ...
            <div class="form-group">
              <select name="whatsapp_number" id="lawyer_whatsapp_number" class="form-control input-sm">
                ...
                <option value="919004780634" {{ '919004780634' == $lawyer->whatsapp_number ? ' selected' : '' }}>919004780634 Indian</option>
                <option value="971545889192" {{ '971545889192' == $lawyer->whatsapp_number ? ' selected' : '' }}>971545889192 Dubai</option>
              </select>
            </div>
