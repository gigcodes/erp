...
<?php foreach($data as $prop) {
	...
	?>
			      <tr>
			        ...
			        <td class='break expand-row-msg' data-name="step_to_reproduce" data-id="<?php echo  $prop->id;  ?>"><span class="show-short-Steps to reproduce-<?php echo  $prop->id;  ?>"><?php echo  $prop->step_to_reproduce_short  ?></span>
