<script type="text/x-jsrender" id="template-create-website">
	<form name="form-create-website" method="post">
		...
		<div class="modal-content">
		   ...
		   <div class="modal-body">
		      ...
		      <div class="form-group col-md-6">
	            ...
	            <input type="text" name="summary" value="{{if data}}{{:data.summary}}{{/if}}" class="form-control" id="name" placeholder="Enter summary">
	         </div>
	           <div class="form-group col-md-6">
		      ...
		      <div class="form-group col-md-6">
		         <label for="bug_type_id">Type of Bug</label>
		         <select name="bug_type_id" class="form-control">
		...
		?>
		       ...
		       <div class="form-group col-md-6">
		         <label for="bug_severity_id">Severity</label>
		         <select name="bug_severity_id" class="form-control">
	            	<option value="">-- N/A --</option>
		            <?php
