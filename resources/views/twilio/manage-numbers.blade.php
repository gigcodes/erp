    ...
    <div class="row mb-3">
        <div class="col-md-10 col-sm-12">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                        <a href="javascript:void(0);" class="btn btn-secondary" data-toggle="modal" data-target="#assignNumberToStock">Assign Numbers</a>
                </div>
            </div>
            @endif
                        ...
                        @if(isset($numbers))
                            @foreach($numbers as $number)
                                <tr>
                                    ...
                                    <td>
                                            {{ $number->assigned_stores->store_website->title }}<br/>
                                    </td>
