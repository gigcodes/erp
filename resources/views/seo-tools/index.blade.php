			...
			<div class="seo_content_inner">
				<div class="seo_text seo_fir col-md-4">
					<div class="seo_text_inner">
						<h6>Keywords</h6>
						<a href="{{route('domain-details', 2)}}"><span>{{$overview['organic_keywords']}}</span></a>
					</div>
				</div>
				<div class="seo_text col-md-4">
					<div class="seo_text_inner">
						<h6>Traffic</h6>
						<a href="{{route('domain-details', 2)}}"><span> {{$overview['organic_traffic']}}</span></a>
					</div>
				</div>
				<div class="seo_text col-md-4">
					<div class="seo_text_inner">
						<h6>Traffic cost</h6>
						<a href="{{route('domain-details', 2)}}"><span>{{$overview['organic_cost']}}</span></a>
					</div>
				</div>
			</div>
		</div>
