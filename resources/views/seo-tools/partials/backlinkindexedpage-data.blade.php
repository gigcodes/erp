...
@foreach($backlink_indexed_page as $i=>$backlink_indexed_pagedetails) 
	<tr>
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlink-indexed-page" data-id="{{$i}}">
				<span class="show-short-backlink-indexed-page-{{$i}}">{{ str_limit('Backlink Indexed Page', $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="source_url" data-id="{{$i}}">
			<span class="show-short-source_url-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['source_url'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="source_title" data-id="{{$i}}">
			<span class="show-short-source_title-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['source_title'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="response_code" data-id="{{$i}}">
			<span class="show-short-response_code-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['response_code'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlinks_num" data-id="{{$i}}">
			<span class="show-short-backlinks_num-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['backlinks_num'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domains_num" data-id="{{$i}}">
			<span class="show-short-domains_num-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['domains_num'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="last_seen" data-id="{{$i}}">
			<span class="show-short-last_seen-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['last_seen'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="external_num" data-id="{{$i}}">
			<span class="show-short-external_num-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['external_num'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="internal_num" data-id="{{$i}}">
			<span class="show-short-internal_num-{{$i}}">{{ str_limit($backlink_indexed_pagedetails['internal_num'], $width, '...')}}</span>
