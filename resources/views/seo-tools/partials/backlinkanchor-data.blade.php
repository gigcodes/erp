...
@foreach($backlink_anchors as $i=>$backlink_anchorsdetails) 
	<tr>
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlink-anchor-report" data-id="{{$i}}">
				<span class="show-short-backlink-anchor-report-{{$i}}">{{ str_limit('Backlink Report', $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="database" data-id="{{$i}}">
			<span class="show-short-database-{{$i}}">{{ str_limit($backlink_anchorsdetails['database'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="anchor" data-id="{{$i}}">
			<span class="show-short-anchor-{{$i}}">{{ str_limit($backlink_anchorsdetails['anchor'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domains_num" data-id="{{$i}}">
			<span class="show-short-domains_num-{{$i}}">{{ str_limit($backlink_anchorsdetails['domains_num'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlinks_num" data-id="{{$i}}">
			<span class="show-short-pbacklinks_num-{{$i}}">{{ str_limit($backlink_anchorsdetails['backlinks_num'], $width, '...')}}</span>
