...
@foreach($domainorganicpage as $i=>$domainorganicpagedetails) 
	<tr>
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domain-organic-page" data-id="{{$i}}">
				<span class="show-short-domain-organic-page-{{$i}}">{{ str_limit('Domain Organic Page', $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="url" data-id="{{$i}}">
			<span class="show-short-url-{{$i}}">{{ str_limit($domainorganicpagedetails['url'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="number_of_keywords" data-id="{{$i}}">
			<span class="show-short-number_of_keywords-{{$i}}">{{ str_limit($domainorganicpagedetails['number_of_keywords'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="traffic" data-id="{{$i}}">
			<span class="show-short-traffic-{{$i}}">{{ str_limit($domainorganicpagedetails['traffic'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="traffic_percentage" data-id="{{$i}}">
			<span class="show-short-traffic_percentage-{{$i}}">{{ str_limit($domainorganicpagedetails['traffic_percentage'], $width, '...')}}</span>
