...
@foreach($backlink_domains as $i=>$backlink_domaindetails) 
	<tr>
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlink-report" data-id="{{$i}}">
				<span class="show-short-backlink-report-{{$i}}">{{ str_limit('Backlink Report', $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="database" data-id="{{$i}}">
			<span class="show-short-database-{{$i}}">{{ str_limit($backlink_domaindetails['database'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domain" data-id="{{$i}}">
			<span class="show-short-domain-{{$i}}">{{ str_limit($backlink_domaindetails['domain'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domain_ascore" data-id="{{$i}}">
			<span class="show-short-domain_ascore-{{$i}}">{{ str_limit($backlink_domaindetails['domain_ascore'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="backlinks_num" data-id="{{$i}}">
			<span class="show-short-pbacklinks_num-{{$i}}">{{ str_limit($backlink_domaindetails['backlinks_num'], $width, '...')}}</span>
