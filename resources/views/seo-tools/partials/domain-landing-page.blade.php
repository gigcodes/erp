...
@foreach($domainlandingpage as $i=>$domainlandingpagedetails) 
	<tr>
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="domain-landing-page" data-id="{{$i}}">
				<span class="show-short-domain-landing-page-{{$i}}">{{ str_limit('Domain Landing Page', $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="target_url" data-id="{{$i}}">
			<span class="show-short-target_url-{{$i}}">{{ str_limit($domainlandingpagedetails['target_url'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="first_seen" data-id="{{$i}}">
			<span class="show-short-first_seen-{{$i}}">{{ str_limit($domainlandingpagedetails['first_seen'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="last_seen" data-id="{{$i}}">
			<span class="show-short-last_seen-{{$i}}">{{ str_limit($domainlandingpagedetails['last_seen'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="times_seen" data-id="{{$i}}">
			<span class="show-short-times_seen-{{$i}}">{{ str_limit($domainlandingpagedetails['times_seen'], $width, '...')}}</span>
		...
		<td class="expand-row-msg" style="width:{{$width}}%" data-name="ads_count" data-id="{{$i}}">
			<span class="show-short-ads_count-{{$i}}">{{ str_limit($domainlandingpagedetails['ads_count'], $width, '...')}}</span>
