                    ...
                    '<div style="border: 1px solid #bfc0bf;padding:0px 5px;">'+
                        '<div data-interval="false" id="carousel_{{ request('websiteId') }}" class="carousel slide" data-ride="carousel">'+
                            '<div class="carousel-inner maincarousel">'+
                                '<div class="item" style="display: block;"> <img src="'+element.images+'" style="height: 150px; width: 150px;display: block;margin-left: auto;margin-right: auto;"> </div>'+
                            '</div>'+
                        '</div>'+
                        '<div class="row pl-4 pr-4" style="padding: 0px; margin-bottom: 8px;">'+
                            ...
                            '</div>'+
                            '<a href="'+element.images+'" download="" data-media="" class="btn btn-md select_row attach-photo"><i class="fa fa-download"></i></a>'+
                        '</div>'+
                    '</div>'+
                '</div>'
            });
