                            ...
                            <div class="infinite-scroll">
                              <table class="table table-sm table-bordered">
                                  ...
                                  <tr>
                                     ...
                                     <td class="p-2" width="20%"><a href="{{ $meetings->start_meeting_url }}" target="_blank">{{ $meetings->start_meeting_url }}</a></td>
                                  </tr>
                                 @endforeach
                                  @endif
                                  </tbody>
                                ...
                                <tbody>
                                 ...
                                 @foreach($pastMeetings as $pastmeetings)
                                  <tr>
                                     ...
                                     <td class="p-2" width="20%"><a href="{{ $pastmeetings->start_meeting_url }}" target="_blank">{{ $pastmeetings->start_meeting_url }}</a></td>
                                  </tr>
                                 @endforeach
                                  @endif
                                </tbody>
