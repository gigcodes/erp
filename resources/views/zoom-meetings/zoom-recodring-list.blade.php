                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                        <input type="text" name="description" class="form-control description" placeholder="Description" value={{ ($meeting->description ?? "" )}}>
                        <button class="btn btn-xs btn-image update_description" data-id="{{ $meeting->id }}"><i class="fa fa-pencil"></i></button>
                        <button type="button" class="btn btn-xs btn-image load-description-history" data-id="{{ $meeting->id }}" data-type="description" title="view History">
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-xs btn-image load-video-preview" data-id="{{ $meeting->id }}" title="preview">
                ...
                <form action="{{ route('meeting.add.user.permission') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group custom-select2">
                            ...
                            @endphp
                            <select class="form-control select2" id="user_record_permission" multiple="multiple" name="user_record_permission[]">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        $("#zoom-record-description-listing").find(".zoom-record-description-listing-view").html(html);
