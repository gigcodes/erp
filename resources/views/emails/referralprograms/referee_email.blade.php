...
<head>
  ...
  <title>You have been refered</title>
  <style type="text/css">
   ...
   <div style="width: 800px; margin: 30px auto; border:2px solid #f4e7e1;">
      ...
      <div style="width: 100%;background-color: #f4e7e1;padding: 0 30px;">
        <table>
          <tbody>
            <tr>
              <td>
                <h1>You have been refered by</h1>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div style="width: 100%;padding: 30px;">
        <table border="0" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
              <td style="color: #898989;font-size: 13px;padding-top: 5px;padding-bottom: 10px;">Please signup using <a href="{{ $referlink }}">link</a> to use your free coupon {{$referee_coupon}}.</td>
            </tr>
            <tr>
               <td style="color: #000000;font-size: 13px;padding-top: 5px;padding-bottom: 10px;font-weight: bold;">Thanks, Team Solo Luxury</td>
            </tr>
          </tbody>
        </table>
      </div>
