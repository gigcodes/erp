@foreach($logListMagentos as $item)
			    <tr>
                  ...
                  <td class="expand-row-msg" data-name="brand_name" data-id="{{$item->id}}">
                    <span class="show-short-brand_name-{{$item->id}}">{{ str_limit($item->brand_name, 7, '...')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="sync_status" data-id="{{$item->id}}">
                    <span class="show-short-sync_status-{{$item->id}}">{{ str_limit($item->sync_status, 13, '...')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="job_start_time" data-id="{{$item->id}}">
                        <span class="show-short-job_start_time-{{$item->id}}">{{ str_limit($item->job_start_time, 10, '...')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="job_end_time" data-id="{{$item->id}}">
                        <span class="show-short-job_end_time-{{$item->id}}">{{ str_limit($item->job_end_time, 10, '...')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="queue" data-id="{{$item->id}}">
                    <span class="show-short-queue-{{$item->id}}">@if($item->queue) {{ str_limit('#'.$item->queue_id.'('.$item->queue.')', 8, '...')}} @else - @endif</span>
