@foreach($logListMagentos as $item)
			    <tr>
                  ...
                  <td class="expand-row-msg" data-name="log_created_at" data-id="{{$item->id}}">
                    <span class="show-short-log_created_at-{{$item->id}}">
                      @if(isset($item->log_created_at))
                        {{ str_limit(date('M d, Y',strtotime($item->log_created_at)), 5, '..') }}
                      @endif
                    </span>
                  ...
                  <td class="expand-row-msg" data-name="website_title" data-id="{{$item->id}}">
                    <span class="show-short-website_title-{{$item->id}}">{{ str_limit($item->website_title, 6, '..')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="job_start_time" data-id="{{$item->id}}">
                        <span class="show-short-job_start_time-{{$item->id}}">{{ str_limit($item->job_start_time, 8, '..')}}</span>
                  ...
                  <td class="expand-row-msg" data-name="job_end_time" data-id="{{$item->id}}">
                        <span class="show-short-job_end_time-{{$item->id}}">{{ str_limit($item->job_end_time, 8, '..')}}</span>
                  ...
                  <span class="show-short-log_user_name-{{$item->id}}">{{ str_limit($item->log_user_name, 2, '..')}}</span>
