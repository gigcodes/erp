...
<div class="panel-group" id="accordion1" role="tablist" aria-multiselectable="true">
    ...
    <div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">
                ...
                <div class="form-group row">
                        <label for="start" class="col-sm-3 col-form-label required">Website</label>
                        <div class="col-sm-8">
                                <select class="form-control select select2" name="store_website_id_edit" onchange="getWebsitesByStoreId(this);">
                                    @foreach($store_websites as $ws)
                                        <option value="{{ $ws->id }}" {{ $result->store_website_id == $ws->id ? "selected" : ""}}>{{ $ws->website }}</option>
                                    @endforeach
                                </select>
                        </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="start" class="col-sm-3 col-form-label required">Website Store</label>
                    <div class="col-sm-8">
                            <select class="form-control select select2 required websites_edit" name="website_ids_edit" multiple="true" id="website_ids_edit" multiple="true">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                            ...
                            @endphp
                            <select class="form-control select select2 required customers_edit" name="customer_groups_edit" multiple="true" id="customer_groups_edit" multiple="true">
