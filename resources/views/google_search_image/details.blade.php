                        ...
                        <?php foreach($result["pages"] as $pages) { ?>
                          <div class="col-md-4" style="float:left">
                            <div class="panel panel-primary">
                              <div class="panel-body"><img src="<?php echo substr($result['image'],0,4) == '/var' ? substr($result['image'], strrpos($result['image'], '/public') + 7) : $result['image'] ?>" class="img-responsive" style="width:250px; height:250px;" alt="Image"></div>
