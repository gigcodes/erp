...
@section('large_content')
        ...
        <div class="col-xs-12">
            <form class="form-search-data">
                ...
                <div class="row">
                    ...
                    @if(auth()->user()->checkPermission('activity-list'))
                        <div class="col-xs-12 col-md-2 pd-2">
                            <div class="form-group ml-3">
                                <select id="search_by_user" class="form-control select2" name="selected_user[]"
                                        multiple>
                        ...
                        <div class="col-xs-12  col-md-1 pd-2">
                            <div class="form-group ml-3">
                                <select id="master_user_id" class="form-control select2"
                                        name="search_second_master_user_id" id="search_second_master_user_id">
                    ...
                    <button type="button" class="btn btn-image btn-call-data"><img
                                src="{{asset('images/filter.png')}}" /></button>
                    <button type="button" style="height: 30px;"
                            class="btn btn-secondary cls_comm_btn priority_model_btn">Priority
                    </button>
                </div>
            ...
            <form action="{{ route('task.create.task.shortcut') }}" method="POST" id="taskCreateForm">
                ...
                @if(auth()->user()->isAdmin())
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-2 pd-2">
                            <div class="form-group">
                                <textarea rows="1" class="form-control input-sm cls_task_detailstextarea"
                                          name="task_detail" placeholder="Task Details" id="task_details"
                                          required>{{ old('task_detail') }}</textarea>
                                ...
                                <div class="cls_multi_contact">
                                    ...
                                    <div class="cls_multi_contact_second">
                                        <button type="button" class="btn btn-image" data-toggle="modal"
                                                data-target="#createQuickContactModal"><img
                            ...
                            <div class="form-inline">
                                <div class="cls_categoryfilter_box">
                                    ...
                                    <div class="cls_categoryfilter_second">
                                        <button type="button" class="btn btn-image" data-toggle="modal"
                                                data-target="#createTaskCategorytModal"><img
                                                    src="{{asset('images/add.png')}}" /></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4" style="display: none;padding-left: 15px;"
    ...
    <div id="exTab2" style="overflow: auto">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#1" data-toggle="tab" class="btn-call-data" data-type="pending">Pending Task</a>
            </li>
            ...
            <li>
                <button type="button"
                        onclick="window.location.href = '{{ action([\App\Http\Controllers\DevelopmentController::class, 'exportTask'],request()->all()) }}'"
                        class="btn btn-xs btn-secondary my-3" role="link"> Download Tasks
                </button>
            </li> &nbsp;
            <li>
                <button type="button" class="btn btn-xs btn-secondary my-3" id="view_tasks_button" data-selected="0">
                    View Tasks
                </button>
            </li>&nbsp;
            <li>
            ...
            @if(Auth::user()->isAdmin())
                <li>
                    <button type="button" class="btn btn-xs btn-secondary my-3" data-toggle='modal'
                            data-target='#taskStatusModal' id="">Create Status
                    </button>
                </li>&nbsp;
            @endif
            @if (Auth::user()->isAdmin())
                <li>
                    <button class="btn btn-xs btn-secondary my-3" style="color:white;" data-toggle="modal"
                            data-target="#newStatusColor"> Status Color
                    </button>
                </li>&nbsp;
            @endif
            @if (Auth::user()->isAdmin())
                <li>
                    <button class="btn btn-xs btn-secondary my-3" style="color:white;" data-toggle="modal"
                            data-target="#taskcolumnvisibilityList"> Column Visiblity
                    </button>
                </li>
            @endif
        </ul>
        <div class="tab-content ">
            <div class="tab-pane active" id="1">
                <div class="row" style="margin:0px;">
                    <div class="col-12">
                        <img class="infinite-scroll-products-loader center-block" src="{{asset('/images/loading.gif')}}"
                                                ...
                                                @if (!in_array('Assign To', $dynamicColumnsToShowTask))
                                                    ...
                                                    {{ $users_list }}
                                                        ...
                                                        <button style="float:right;padding-right:0px;" type="button"
                                                                class="btn btn-xs show-user-history"
                                                                title="Show History" data-id="{{$task->id}}"><i
                                                                    class="fa fa-info-circle"></i></button>
                                                        <div class="col-md-12 expand-col-lead{{$task->id}} dis-none"
                                                             style="padding:0px;">
                                                            <br>
                                                            @if(auth()->user()->isAdmin()  || $isTeamLeader)
                                                                <label for="" style="font-size: 12px;margin-top:10px;">Lead
                                                                    :</label>
                                                                @php
                                                        ...
                                                        <div class="col-md-12 expand-col" style="padding:0px;">
                                                            @if(!$task->hubstaff_task_id && (auth()->user()->isAdmin() || auth()->user()->id == $task->assign_to))
                                                                <button type="button"
                                                                        ...
                                                                        data-id="{{$task->id}}" data-type="developer">
                                                                    Create D Task
                                                                </button>
                                                            @endif
                                                        ...
                                                        @if ($task->assign_to == Auth::id() || ($task->assign_to != Auth::id() && $task->is_private == 0))
                                                            <div style="margin-bottom:10px;width: 100%;">
                                                                ...
                                                                <textarea rows="2"
                                                                          ...
                                                                          id="getMsg{{$task->id}}" name="message"
                                                                    ...
                                                                    <div style="margin-bottom:10px;width: 100%;">
                                                                        ...
                                                                        @else
                                                                            <div class="d-flex justify-content-between expand-row-msg"
                                                                                 data-id="{{$task->id}}">
                                                                        <span class="td-mini-container-{{$task->id}}"
                                                                              style="margin:0px;">
                                                                        <?php
                                                                    ...
                                                                    <div class="expand-col dis-none">
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <input type="text" style="width: 100%;"
                                                                                   ...
                                                                                   value="">
                                                                            <div style="max-width: 30px;">
                                                                                <button class="btn btn-sm btn-image send-message-lead"
                                                                                        title="Send message"
                                                                                        data-taskid="{{ $task->id }}">
                                                    ...
                                                    <td class="p-2">
                                                        ...
                                                        @if(!empty($time_history))
                                                            ...
                                                            <button type="button" class="btn btn-xs show-timer-history"
                                                                    title="Show timer History" data-id="{{$task->id}}">
                                                            ...
                                                            <div class="row cls_action_box" style="margin:0px;">
                                                                @if(auth()->user()->isAdmin())
                                                                    <button type="button"
                                                                            ...
                                                                            data-id="{{ $task->id }}"
                                                                            data-toggle='modal'
                                                                            data-target='#whatsAppMessageModal'><img
                                                                ...
                                                                @if ($special_task->users->contains(Auth::id()) || $task->assign_from == Auth::id() || $task->master_user_id == Auth::id() || $task->second_master_user_id == Auth::id())
                                                                    ...
                                                                    <button type="button"
                                                                            ...
                                                                            data-id="{{ $task->message_id }}"
                                                                            data-toggle='modal'
                                                                            data-target='#reminderMessageModal'><img
                                            ...
                                            <tr style="background-color: {{$status_color->task_color ?? ""}}!important;"
                                                ...
                                                <td class="table-hover-cell p-2">
                                                    ...
                                                    <button style="float:right;padding-right:0px;" type="button"
                                                            ...
                                                            data-id="{{$task->id}}"><i class="fa fa-info-circle"></i>
                                                    </button>
                                                    <div class="col-md-12 expand-col-lead{{$task->id}} dis-none"
                                                         style="padding:0px;">
                                                        <br>
                                                    ...
                                                    <div class="col-md-12 expand-col" style="padding:0px;">
                                                        @if(!$task->hubstaff_task_id && (auth()->user()->isAdmin() || auth()->user()->id == $task->assign_to))
                                                            <button type="button"
                                                                    class="btn btn-xs create-hubstaff-task"
                                                                    title="Create Hubstaff task for User"
                                                                    data-id="{{$task->id}}" data-type="developer">Create
                                                                D Task
                                                            </button>
                                                        @endif
                                                        @if(!$task->lead_hubstaff_task_id && $task->master_user_id && (auth()->user()->isAdmin() || auth()->user()->id == $task->master_user_id))
                                                            <button style="margin-top:10px;color:black;" type="button"
                                                                    class="btn btn-secondary btn-xs create-hubstaff-task"
                                                                    title="Create Hubstaff task for Master user"
                                                                    data-id="{{$task->id}}" data-type="lead">Create L
                                                                Task
                                                            </button>
                                                        @endif
                                                        <button style="float:right;padding-right:0px;" type="button"
                                                ...
                                                <td class="p-2">
                                                    ...
                                                    @if(!empty($time_history))
                                                        ...
                                                        @else
                                                            <input type="hidden" value="{{$task->m_start_date}}"
                                                                   class="m_start_date_" id="m_start_date_{{$task->id}}"
                                                                   data-id="{{$task->id}}"
                                                                   data-value="{{$task->m_start_date}}">
                                                            <button data-task="{{$task->id}}" title="Start Task"
                                                                    data-type="TASK" class="btn btn-sm startDirectTask"
                                                        ...
                                                        <button type="button" class="btn btn-xs show-timer-history"
                                                                title="Show timer History" data-id="{{$task->id}}"><i
                                                                    class="fa fa-info-circle"></i></button>
                                                    @endif
                                                </td>
                                                @php
                                                    ...
                                                    <div>
                                                        <div class="row cls_action_box" style="margin:0px;">
                                                            @if(auth()->user()->isAdmin())
                                                                ...
                                                                <button type="button"
                                                                        class='btn delete-single-task pd-5'
                                                                        data-id="{{ $task->id }}"><i class="fa fa-trash"
                                                                                                     aria-hidden="true"></i>
                                                                </button>
                                                            @endif
                                        ...
                                        <tr style="background-color: {{$status_color->task_color ?? ""}}!important;"
                                            ...
                                            <td class="p-2">
                                                @if(auth()->user()->isAdmin())
                                                    <input type="checkbox" name="selected_issue[]" value="{{$task->id}}"
                                                           title="Task is in priority" {{in_array($task->id, $priority) ? 'checked' : ''}}>
                                                @endif
                                                <input type="checkbox" title="Select task" class="select_task_checkbox"
                                                       name="task" data-id="{{ $task->id }}" value=""></br>
                                                {{ $task->id }}
                                            </td>
                                            <td class="p-2">{{ Carbon\Carbon::parse($task->created_at)->format('d-m H:i') }}
                                                <br>
                                            ...
                                            <td class="table-hover-cell p-2">
                                                ...
                                                <div class="col-md-12 expand-col-lead{{$task->id}} dis-none"
                                                    ...
                                                    @if(auth()->user()->isAdmin()  || $isTeamLeader)
                                                        <label for="" style="font-size: 12px;margin-top:10px;">Lead 2
                                                            :</label>
                                                        @php
                                                            $selectBoxId = 'master_user_id';
                                                            $selectClass = "assign-master-user";
                                            ...
                                            <td>
                                                @if (isset($special_task->timeSpent) && $special_task->timeSpent->task_id > 0)
                                                    ...
                                                    <button style="float:right;padding-right:0px;" type="button"
                                                            class="btn btn-xs show-tracked-history"
                                                            title="Show tracked time History" data-id="{{$task->id}}"
                                                            data-type="developer"><i class="fa fa-info-circle"></i>
                                                    </button>
                                                @endif
                                                ...
                                                <div class="col-md-12 expand-col" style="padding:0px;">
                                                    @if(!$task->hubstaff_task_id && (auth()->user()->isAdmin() || auth()->user()->id == $task->assign_to))
                                                        <button type="button" class="btn btn-xs create-hubstaff-task"
                                                                title="Create Hubstaff task for User"
                                                                data-id="{{$task->id}}" data-type="developer">Create D
                                                            Task
                                                        </button>
                                                    @endif
                                                    @if(!$task->lead_hubstaff_task_id && $task->master_user_id && (auth()->user()->isAdmin() || auth()->user()->id == $task->master_user_id))
                                                        <button style="margin-top:10px;color:black;" type="button"
                                                                class="btn btn-secondary btn-xs create-hubstaff-task"
                                                                title="Create Hubstaff task for Master user"
                                                                data-id="{{$task->id}}" data-type="lead">Create L Task
                                                        </button>
                                                    @endif
                                                    <button style="float:right;padding-right:0px;" type="button"
                                                            class="btn btn-xs show-hubtask-log-history"
                                                            title="Show create hubtask Logs" data-id="{{$task->id}}"><i
                                                                class="fa fa-info-circle"></i></button>
                                                </div>
                                            </td>
                                            <td class="table-hover-cell p-2 {{ ($task->message && $task->message_status == 0) || $task->message_is_reminder == 1 || ($task->message_user_id == $task->assign_from && $task->assign_from != Auth::id()) ? 'text-danger' : '' }}">
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            @if (isset($task->message))
                                                                <div style="max-width: 30px;">
                                                                    <button type="button"
                                                                            class="btn btn-xs btn-image load-communication-modal"
                                                                            data-object='task' data-id="{{ $task->id }}"
                                                                            title="Load messages"><img
                                                                                src="{{asset('images/chat.png')}}"
                                                                                alt=""></button>
                                                                </div>
                                                ...
                                                <div>
                                                    <div class="row cls_action_box" style="margin:0px;">
                                                        @if(auth()->user()->isAdmin())
                                                            ...
                                                            <button type="button" class='btn delete-single-task pd-5'
                                                                    data-id="{{ $task->id }}"><i class="fa fa-trash"
                                                                                                 aria-hidden="true"></i>
                                                            </button>
                                                        @endif
                                                        ...
                                                        <button class="btn btn-image expand-row-btn-lead"
                                                                data-task_id="{{ $task->id }}"><img
                                                                    src="/images/forward.png"></button>
                                                        <button class="btn btn-image set-remark"
                                                                data-task_id="{{ $task->id }}" data-task_type="TASK"><i
                                                        ...
                                                        <button class="btn btn-image mt-2 show-created-task-document"
                                                                title="Show created document" data-id="{{$task->id}}">
                                                            <i class="fa fa-list" aria-hidden="true"></i>
                                                        </button>

                                                        <a title="Task Information: Update" class="btn btn-image mt-2"
                            ...
                            <form action="{{ route('task.assign.messages') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <select class="selectpicker form-control input-sm" data-live-search="true"
                                        ...
                                        @foreach ($data['task']['pending'] as $task)
                                            <option data-tokens="{{ $task->id }} {{ $task->task_subject }} {{ $task->task_details }} {{ array_key_exists($task->assign_from, $users) ? $users[$task->assign_from] : '' }} {{ array_key_exists($task->assign_to, $users) ? $users[$task->assign_to] : '' }}"
                                                    value="{{ $task->id }}">{{ $task->id }}
                                                from {{ @$users[$task->assign_from] }} {{ $task->task_subject }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
    ...
    <div id="loading-image"
         style="position: fixed;left: 0px;top: 0px;width: 100%;height: 100%;z-index: 9999;background: url('/images/pre-loader.gif') 50% 50% no-repeat;display:none;"></div>
