...
<div class="row mb-2">
    ...
    <div id="exTab2" style="overflow: auto">
        <ul class="nav nav-tabs">
            ...
            <li><button class="btn btn-xs btn-secondary my-3" onclick="window.location.href = '{{ action('DevelopmentController@exportTask',request()->all()) }}' " > Download Tasks </button></li> &nbsp;
