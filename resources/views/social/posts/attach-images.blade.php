...
<!-- <li>
        <div>
            <input type="radio" name="image" value="{{ urldecode($list->getUrl()) }}">
            <img src="{{ urldecode($list->getUrl())}}" alt="{{ $list->name }}">
        </div>
            ...
            <div style="border: 1px solid #bfc0bf;padding:0px 5px;">
                <div data-interval="false" id="carousel_{{ request('websiteId') }}" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner maincarousel">
                        ...
                        <img src="{{ urldecode($list->getUrl())}}" style="height: 150px; width: 150px;display: block;margin-left: auto;margin-right: auto;">    
                        <input type="checkbox" name="image[]" value="{{ urldecode($list->getUrl()) }}">
                        </div>
                    </div>
                </div>
