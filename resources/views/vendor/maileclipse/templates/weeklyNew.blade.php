...
<tbody>
<tr>
<td class="header-lg">{{product_title}}</td>
</tr>
<tr>
<td class="free-text">&nbsp;</td>
</tr>
<tr>
<td class="mini-block-container">
...
<tbody>
<tr>
<td class="mini-img"><a href="{{$product['img'][0]}}">Some Link</a></td>
