...
<tr>
<td>
<div style="font-size: 13px; line-height: 1.62; color: #898989; margin: 5px 0;">You've got great taste! We're so glad you chose noon.</div>
</td>
</tr>
<tr>
<td>
...
@include('emails.orders.partials.order-summary') @include('emails.orders.partials.order-product-summary')
<div style="width: 100%; padding: 30px;">
<table border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
