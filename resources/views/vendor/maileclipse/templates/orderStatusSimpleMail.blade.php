...
<div style="width: 100%; text-align: center; padding-top: 30px; background-color: #f4e7e1;"><img src="https://app.scrapersololuxury.com/images/emails/logo.png" alt="" /></div>
...
<tr>
<td>
<div style="font-size: 13px; line-height: 1.62; color: #898989;">Your order {{ $order->order_id }} has been updated to {{ $order->order_status }}.</div>
</td>
</tr>
</tbody>
</table>
