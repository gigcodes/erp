...
<div class="row">
  <div class="col-md-6">
    <img src="{{ $image->filename ? (asset('uploads/social-media') . '/' . $image->filename) : ($image->getMedia(config('constants.media_tags'))->first() ? getMediaUrl($image->getMedia(config('constants.media_tags'))->first()) : '') }}" class="img-responsive" alt="">
