                ...
                <div class="col-md-2 col-xs-3 text-center">
                    ...
                    @foreach( $image->productImg( $image->product_id, $image->id ) as $img )
                        @if(!$loop->last)
                            <div class="col-md-2 col-xs-3 text-center">
                                <div class="thumbnail">
                                    <img src="{{ $img->filename ? (asset('uploads/social-media') . '/' . $img->filename) : ($img->getMedia(config('constants.media_tags'))->first() ? getMediaUrl($img->getMedia(config('constants.media_tags'))->first()) : '') }}" class="img-responsive grid-image" alt="" />
