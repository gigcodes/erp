...
<div class="row">
  ...
  <div class="col-md-3 col-xs-6 text-center mb-5">
    <img src="{{ $image->hasMedia(config('constants.media_tags')) ? getMediaUrl($image->getMedia(config('constants.media_tags'))->first()) : '#no-image' }}" class="img-responsive grid-image" alt="" onclick="sendBroadCastAll({{ $image->id }})" />
