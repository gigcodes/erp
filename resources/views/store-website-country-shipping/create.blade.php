          ...
          <div class="card-body">
            <form method="POST" action="{{ route('store-website-country-shipping.create') }}" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                  <input id="currency" name="currency" placeholder="Currency" type="text" class="form-control {{ $errors->has('currency') ? ' is-invalid' : '' }}" value="{{old('currency')}}" required="required" >
