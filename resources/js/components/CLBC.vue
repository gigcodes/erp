  ...
  <div>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input
                ...
                v-model="broadcast.number_of_users"
              />
            </div>
            ...
            <div class="form-group">
              <button @click="saveBroadcast" class="btn btn-success">
                Save
              </button>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="row">
            ...
            <div
              class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-right pb-2 mb-3 float-right"
            >
              <div
                v-if="paginationData.show"
                class="input-group mr-2 pull-right"
              >
                <input
                  v-on:keyup.13="getColdLeads()"
        ...
        <div class="col-md-4 text-right">
          <a href="/cold-leads" class="btn btn-primary btn-sm"
            >View Cold Leads</a
          >
    ...
    <table class="table table-striped table-sm table-bordered mt-4">
      ...
      <tbody>
        <tr v-if="isLoading">
          <td colspan="6">
            <h1 class="text-center">Loading broadcasts...</h1>
          </td>
        </tr>
        <tr v-for="(lead, index) in leads">
          ...
          <td>
            <strong>{{ lead.status ? "Active" : "Inactive" }}</strong>
          </td>
          <td>
            <bar
              :key="'lead_' + lead.id"
