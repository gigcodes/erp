...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->setPageTitle(trans('bookstack::settings.settings'));
    ...
    public function showMaintenance()
    {
        ...
        return view('bookstack::settings.maintenance', ['version' => $version]);
    }
    ...
    public function cleanupImages(Request $request, ImageService $imageService)
    {
        ...
        if ($dryRun) {
            session()->flash('cleanup-images-warning', trans('bookstack::settings.maint_image_cleanup_warning', ['count' => $deleteCount]));
        } else {
            session()->flash('success', trans('bookstack::settings.maint_image_cleanup_success', ['count' => $deleteCount]));
        }

        return redirect('/kb/settings/maintenance#image-cleanup')->withInput();
    }
}
