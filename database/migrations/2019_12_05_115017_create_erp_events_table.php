...
class CreateErpEventsTable extends Migration {
	...
	public function up()
	{
		Schema::create('erp_events', function(Blueprint $table)
		{
			...
			$table->dateTime('product_start_date')->default('0000-00-00 00:00:00');
			$table->dateTime('product_end_date')->default('0000-00-00 00:00:00');
			$table->string('minute', 5)->default('0');
			$table->string('hour', 5)->default('0');
			$table->string('day_of_month', 5)->default('0');
			$table->string('month', 5)->default('0');
			$table->string('day_of_week', 5)->default('0');
