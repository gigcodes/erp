...
function scraper_restart
{
	...
	do
		...
		then
			...
			echo $email |mail -s "No Scraper server has free memory more than 5% so exiting script" sahilkataria.1989@gmail.com
			echo $email |mail -s "No Scraper server has free memory more than 5% so exiting script" yogeshmordani@icloud.com 
